...
export type { ServerClass as ServerClassType } from './ServerClass';

const isDev = process.env.NODE_ENV === 'development';

export async function initializeServer(config: ServerConfig): Promise<void> {
  ...
  (globalThis as any)._$venkyServer = server;
