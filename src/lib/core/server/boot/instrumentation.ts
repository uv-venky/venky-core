...
function resolvePingOptions(options?: InstrumentationPingOptions) {
...
function isAbortedErrorLog(...args: unknown[]): boolean {
 ...
 */
export async function registerCoreInstrumentation(options?: InstrumentationPingOptions): Promise<void> {
...
export async function onCoreRequestError(err: Error, _request: { path: string; method: string }): Promise<void> {
