 ...
 */
async function validateSamlXml(xml: string) {
...
export async function getProviders(url: string) {
...
export async function createLogoutRequest(url: string, logoutNameID: string, sessionIndex: string) {
