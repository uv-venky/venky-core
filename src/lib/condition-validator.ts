 ...
 */
export function validateConditionExpression(expression: string): ValidationResult {
 ...
 */
export function preValidateConditionExpression(expression: string): ValidationResult {
