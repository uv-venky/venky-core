...
import type { RelayStateContext, RelayStateProcessorResult } from '@/lib/core/server/relay-state-plugin';
import type { RelayStateProcessor } from '@/lib/core/server/relay-state-plugin';

async function dashboardRelayStateProcessor(context: RelayStateContext): Promise<RelayStateProcessorResult | null> {
...
const relayStateProcessors: RelayStateProcessor[] = [dashboardRelayStateProcessor];
