...
async function pollForResult(statusUrl: string, responseUrl: string, apiKey: string): Promise<FalUpscaleResponse> {
 ...
 */
async function stepHandler(input: FalUpscaleImageCoreInput, credentials: FalCredentials): Promise<UpscaleImageResult> {
 ...
 */
export async function falUpscaleImageStep(input: FalUpscaleImageInput): Promise<UpscaleImageResult> {
