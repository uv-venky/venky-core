 ...
 */
async function pollForResult(statusUrl: string, responseUrl: string, apiKey: string): Promise<FalImageResponse> {
 ...
 */
export async function falGenerateImageStep(input: FalGenerateImageInput): Promise<GenerateImageResult> {
