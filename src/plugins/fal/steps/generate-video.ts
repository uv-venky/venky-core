 ...
 */
async function pollForResult(statusUrl: string, responseUrl: string, apiKey: string): Promise<FalVideoResponse> {
 ...
 */
export async function falGenerateVideoStep(input: FalGenerateVideoInput): Promise<GenerateVideoResult> {
