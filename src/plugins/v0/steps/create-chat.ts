 ...
 */
async function stepHandler(input: CreateChatCoreInput, credentials: V0Credentials): Promise<CreateChatResult> {
 ...
 */
export async function createChatStep(input: CreateChatInput): Promise<CreateChatResult> {
