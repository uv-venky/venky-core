...
type FindIssuesResult = { success: true; issues: LinearIssue[]; count: number } | { success: false; error: string };
 ...
 */
async function stepHandler(input: FindIssuesCoreInput, credentials: LinearCredentials): Promise<FindIssuesResult> {
 ...
 */
export async function findIssuesStep(input: FindIssuesInput): Promise<FindIssuesResult> {
