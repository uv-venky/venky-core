...
async function stepHandler(input: GetCustomerCoreInput, credentials: StripeCredentials): Promise<GetCustomerResult> {
...
export async function getCustomerStep(input: GetCustomerInput): Promise<GetCustomerResult> {
