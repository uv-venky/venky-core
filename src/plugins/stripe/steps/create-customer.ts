...
type CreateCustomerResult = { success: true; id: string; email: string } | { success: false; error: string };
...
export async function createCustomerStep(input: CreateCustomerInput): Promise<CreateCustomerResult> {
