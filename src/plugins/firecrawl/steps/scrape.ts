 ...
 */
async function stepHandler(input: FirecrawlScrapeCoreInput, credentials: FirecrawlCredentials): Promise<ScrapeResult> {
 ...
 */
export async function firecrawlScrapeStep(input: FirecrawlScrapeInput): Promise<ScrapeResult> {
