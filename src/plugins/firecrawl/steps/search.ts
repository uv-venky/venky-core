 ...
 * Core logic
 */
async function stepHandler(input: FirecrawlSearchCoreInput, credentials: FirecrawlCredentials): Promise<SearchResult> {
 ...
 */
export async function firecrawlSearchStep(input: FirecrawlSearchInput): Promise<SearchResult> {
