...
type SendSlackMessageResult = { success: true; ts: string; channel: string } | { success: false; error: string };
 ...
 */
export async function sendSlackMessageStep(input: SendSlackMessageInput): Promise<SendSlackMessageResult> {
