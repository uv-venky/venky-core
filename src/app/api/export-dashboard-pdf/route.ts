...
async function addImagePage(pdfDoc: PDFDocument, font: PDFFont, image: string, title?: string) {
...
export const POST = withSessionRoute(async (_session: Session, req: Request) => {
  let payload: Payload;
  try {
