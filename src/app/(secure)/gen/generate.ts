...
import type { GenerateCode, State } from './types';
...
async function updateDataSourceIndex(dsName: string, moduleCode: string) {
...
async function genCode(state: State, generateCodeFn: GenerateCode, filePath: string) {
...
async function updateActionsIndex({ dsName, moduleCode, subModuleCode, pageRouteName }: State) {
...
export default async function generate(state: State) {
