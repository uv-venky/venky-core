...
import type { State, Table, TemplateOption } from './types';
...
export default function PageContent({ modules, subModules, templateOptions: templateOptionsProp }: Props) {
  ...
  return (
    <Card className="mt-4 flex flex-1 flex-col overflow-hidden">
      ...
      <CardContent className="scrollbar-thin scrollbar-track-transparent scrollbar-thumb-muted-foreground/20 hover:scrollbar-thumb-muted-foreground/40 flex-1 overflow-y-auto">
        <div className="grid grid-cols-3 items-start gap-4">
          ...
          <AsyncComboboxInput
            ...
            required
            getOptions={async (filter): Promise<Table[]> => {
          ...
          {state.tableName && state.dsName && state.createPage && (
            <>
              <BooleanInput
                label="Editable"
                labelOnTop
