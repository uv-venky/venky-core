...
export type ActionConfigFieldBase = {
    key: string;
    label: string;
    type: 'template-input' | 'template-textarea' | 'text' | 'number' | 'select' | 'combobox' | 'schema-builder' | 'single-row-update' | 'match-builder' | 'multi-select' | 'action-params';
 ...
 */
export declare function getCredentialMapping(plugin: IntegrationPluginBase, config: Record<string, unknown>): Record<string, string>;
/**
