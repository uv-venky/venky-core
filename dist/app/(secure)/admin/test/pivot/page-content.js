...
export default function PageContent() {
  ...
  return _jsx(PivotContextProvider, {
    columns: columns,
    initialSettings: settings,
    onSettingsChange: onSettingsChange,
    children: _jsx(PageLayout, {
      title: 'Users Pivot',
      toolbar: _jsx(PivotSettings, {}),
      filterSection: _jsx(Suspense, {
        fallback: _jsx(Suspended, { name: 'Filters' }),
        children: _jsx(PivotFilters, {
          border: 'none',
          store: store,
      ...
      children: _jsx('div', {
        ...
        children: isStoreLoading
          ? _jsx(PivotTableSkeleton, {})
          : _jsx(SimplePivotTable, {
              hideBorders: true,
              data: rows,
