...
export default function AppsPageContent() {
  ...
  const content = isLoading
    ? _jsx('div', {
        ...
        children: _jsx('div', {
          className: 'grid gap-4 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-3',
          children: [1, 2, 3, 4, 5, 6].map((i) => _jsx(Skeleton, { className: 'h-64' }, i)),
        }),
      })
    : _jsxs('div', {
        className: 'container mx-auto space-y-6 p-4',
        children: [
          _jsxs('div', {
            ...
            children: [
              _jsxs('div', {
                ...
                children: [
                  _jsx(Search, { className: 'absolute top-1/2 left-3 size-4 -translate-y-1/2 text-muted-foreground' }),
                  _jsx(Input, {
              ...
              _jsxs('div', {
                ...
                children: [
                  _jsxs(Button, {
                    ...
                    className: 'shrink-0',
                    children: [
                      _jsx(RefreshCw, { className: isRefreshingAll ? 'mr-2 size-4 animate-spin' : 'mr-2 size-4' }),
                      'Refresh All',
                    ],
                  }),
                  _jsxs(Button, {
                    ...
                    size: 'lg',
                    className: 'shrink-0',
                    children: [_jsx(Plus, { className: 'mr-2 size-4' }), isCreating ? 'Creating...' : 'Add New App'],
                  }),
                ],
              }),
            ],
          ...
          filteredApps.length === 0
            ? _jsxs('div', {
                ...
                children: [
                  _jsx(Globe, { className: 'mb-4 size-12 text-muted-foreground' }),
                  _jsx('h3', { className: 'mb-2 font-semibold text-lg', children: 'No apps found' }),
                  _jsx('p', {
                    className: 'mb-4 text-muted-foreground text-sm',
                    children: searchQuery ? 'Try adjusting your search query' : 'Get started by adding your first app',
                  }),
                  !searchQuery &&
                    _jsxs(Button, {
                      onClick: handleCreateNew,
                      disabled: isCreating,
                      children: [_jsx(Plus, { className: 'mr-2 size-4' }), 'Add New App'],
                    }),
                ],
              })
            : _jsx('div', {
  ...
  return _jsxs(_Fragment, {
    children: [
      _jsx(PageLayout, {
        ...
        icon: _jsx(Globe, { className: 'size-12 text-muted-foreground' }),
        enableShareUrl: true,
