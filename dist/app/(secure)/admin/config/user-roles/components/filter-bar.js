        ...
        roleCode &&
          _jsx(UsersLOVCombobox, {
            ...
            trigger: _jsxs(Button, {
              ...
              children: [_jsx(PlusIcon, { className: 'h-4 w-4' }), 'Assign to Users'],
            }),
        ...
        userName &&
          _jsx(RolesLOVCombobox, {
            ...
            trigger: _jsxs(Button, {
              ...
              children: [_jsx(PlusIcon, { className: 'h-4 w-4' }), 'Assign Roles'],
            }),
