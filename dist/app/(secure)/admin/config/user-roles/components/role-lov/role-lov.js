...
export default function RolesLOV({ open, onOpenChange, onSelect, userName }) {
    ...
    return (_jsx(LOVDialog, { open: open, onOpenChange: onOpenChange, store: store, tableColumns: tableColumns, smartSearchColumns: smartSearchColumns, onSelect: onSelect, title: "Select Roles", width: 1100, height: 650, modal: false }));
}
