...
export default function RolesLOVCombobox({ open, onOpenChange, onSelect, userName, value, trigger, }) {
    ...
    return (_jsx(LOVCombobox, { open: open, onOpenChange: onOpenChange, store: store, onSelect: onSelect, title: "Select Roles", placeholder: "Select roles...", searchPlaceholder: "Search roles by name, code, or description...", getLabel: (role) => `${role.roleName} (${role.roleCode})`, getValue: (role) => role.roleCode, getOptions: fetchRoles, getOptionsForValue: getOptionsForValue, minSearchLength: 0, value: value, trigger: trigger }));
}
