        ...
        const columns = [
            {
                ...
                cell: (props) => (_jsx(CompoundCell, { primary: "displayName", secondary: "email", icon: _jsx(User, { className: "size-3.5" }), iconBgClass: "bg-blue-500/10", iconClass: "text-blue-600 dark:text-blue-400", ...props })),
            },
            {
