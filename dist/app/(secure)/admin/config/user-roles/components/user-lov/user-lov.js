...
export default function UsersLOV({ open, onOpenChange, onSelect, roleCode }) {
    ...
    return (_jsx(LOVDialog, { open: open, onOpenChange: onOpenChange, store: store, tableColumns: tableColumns, smartSearchColumns: smartSearchColumns, onSelect: onSelect, title: "Select Users", width: 1100, height: 650, modal: false }));
}
