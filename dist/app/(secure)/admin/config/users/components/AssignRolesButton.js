...
export function AssignRolesDialog({ rowId, onClose }) {
    ...
    return (_jsx(EditPopup, { title: "Assign Roles", description: "Select the roles you want to assign to the user and click save when you're done.", store: userRolesStore, onClose: onClose, width: 980, height: 600, children: _jsx(UserRolesTableWithSearch, { userName: rowId, store: userRolesStore }) }));
}
