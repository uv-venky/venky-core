...
export function AssignToUsersDialog({ rowId, onClose }) {
    ...
    return (_jsx(EditPopup, { width: 980, height: 600, contentClassName: "pb-4", title: "Assign to Users", store: userRolesStore, onClose: onClose, modal: false, children: _jsx(UserRolesTableWithSearch, { roleCode: rowId, store: userRolesStore }) }));
}
