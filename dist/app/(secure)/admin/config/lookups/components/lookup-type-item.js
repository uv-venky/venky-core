      ...
      children: _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              _jsx('span', { className: 'font-medium', children: lookupType.code }),
              _jsxs(Badge, {
          ...
          _jsx('div', { className: 'mt-1 text-muted-foreground text-sm', children: lookupType.name }),
          lookupType.description &&
            _jsx('div', {
              className: 'mt-1 line-clamp-2 text-muted-foreground text-xs',
              children: lookupType.description,
            }),
        ],
      }),
    }),
