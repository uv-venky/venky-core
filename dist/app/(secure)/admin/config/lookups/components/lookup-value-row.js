...
export function LookupValueRow({ lookupValue, lookupType, store }) {
  ...
  if (isEditing) {
    return _jsx('div', {
      className: 'rounded-lg border border-primary bg-accent/50 p-3',
      children: _jsxs('div', {
        className: 'space-y-3',
        children: [
          _jsxs('div', {
          ...
          _jsx(TextInput, { label: 'Label', value: localLabel, onChange: (value) => setLocalLabel(value ?? '') }),
          _jsx(TextInput, {
            label: 'Description',
          ...
          _jsxs('div', {
            ...
            children: [
              ...
              _jsx(Button, { size: 'sm', onClick: handleSave, disabled: isPosting, children: 'Save' }),
            ],
          }),
        ],
      }),
        ...
        _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              ...
              children: [
                _jsx('span', { className: 'font-medium', children: lookupValue.label }),
                _jsxs('span', { className: 'text-muted-foreground text-xs', children: ['(', lookupValue.value, ')'] }),
                lookupValue.displayOrder != null &&
                  _jsxs('span', {
                    className: 'text-muted-foreground text-xs',
                    children: ['Order: ', lookupValue.displayOrder],
                  }),
              ],
            }),
            lookupValue.description &&
              _jsx('div', { className: 'mt-1 text-muted-foreground text-sm', children: lookupValue.description }),
          ],
        }),
        _jsxs('div', {
          ...
          children: [
            ...
            _jsx('div', {
              ...
              children: _jsx(Switch, { checked: lookupValue.isActive, onCheckedChange: handleToggleActive }),
            }),
            _jsx(Button, {
              variant: 'ghost',
              size: 'icon',
