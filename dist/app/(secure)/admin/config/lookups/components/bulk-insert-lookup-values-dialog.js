  ...
  return _jsx(Dialog, {
    ...
    children: _jsxs(DialogContent, {
      ...
      children: [
        _jsxs(DialogHeader, {
          children: [
            _jsx(DialogTitle, { children: 'Bulk Insert Lookup Values' }),
            ...
            _jsxs('div', {
              ...
              children: [
                _jsx('label', {
                  ...
                  children: 'Paste Data (Tab or comma-separated)',
                }),
                _jsx(Textarea, {
                  id: 'bulk-paste',
                  placeholder:
                ...
                _jsx('p', {
                  ...
                  children:
                    'Supports tab-separated (Excel) or comma-separated (CSV) format. First column is Value, second is Label, third is Description (optional), fourth is Display Order (optional).',
                }),
              ],
            }),
            previewRows.length > 0 &&
              _jsxs('div', {
                ...
                children: [
                  _jsxs('div', {
                    className: 'font-medium text-sm',
                    children: ['Preview (', previewRows.length, ' row(s)):'],
                  }),
                  _jsx('div', {
                    className: 'max-h-48 overflow-y-auto rounded border bg-muted/50 p-2',
                    children: _jsxs('div', {
                      className: 'space-y-1',
                      children: [
                        previewRows
                          ...
                          .map((row, index) =>
                            _jsxs(
                              'div',
                              {
                                ...
                                children: [
                                  _jsx('span', { className: 'font-semibold', children: row.value }),
                                  ' \u2192 ',
                                  row.label,
                        ...
                        previewRows.length > 10 &&
                          _jsxs('div', {
                            ...
                            children: ['... and ', previewRows.length - 10, ' more row(s)'],
                          }),
                      ],
                    }),
                  }),
        ...
        _jsxs(DialogFooter, {
          children: [
            ...
            _jsx(Button, {
              onClick: handleSave,
              disabled: isPosting || previewRows.length === 0,
              children: isPosting
                ? _jsxs(_Fragment, {
                    children: [_jsx(Loader2, { className: 'mr-2 h-4 w-4 animate-spin' }), 'Creating...'],
                  })
                : _jsxs(_Fragment, {
                    children: [
