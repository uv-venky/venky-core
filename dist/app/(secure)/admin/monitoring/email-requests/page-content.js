...
export default function EmailRequestsPageContent() {
  ...
  return _jsx(PageLayoutTemplate, {
    ...
    icon: _jsx(Mail, { className: 'h-12 w-12 text-muted-foreground' }),
    store: store,
    ...
    searchOnBlur: true,
    toolbarContent: _jsxs(Button, {
      disabled: isSending,
      onClick: handleSendTestEmail,
      children: [isSending && _jsx(Loader2, { className: 'h-4 w-4 animate-spin' }), ' Send Test Email'],
    }),
  });
}
