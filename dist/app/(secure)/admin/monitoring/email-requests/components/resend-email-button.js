...
export function ResendEmailButton({ rowId }) {
    ...
    return (_jsxs(Button, { variant: "ghost", size: "sm", className: "h-8 gap-1 px-2", disabled: isResending, onClick: (e) => {
            e.stopPropagation();
            void handleResend();
        }, "data-tip": "Resend email", activityId: "no-log", children: [isResending ? _jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : _jsx(RotateCcw, { className: "h-4 w-4" }), "Resend"] }));
}
