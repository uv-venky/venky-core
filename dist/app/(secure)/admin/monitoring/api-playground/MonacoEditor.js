...
export default function MonacoEditor({ value, onChange, placeholder, disabled, datasourceId, type = 'Query', }) {
    ...
    return (_jsxs(Container, { className: "relative h-full w-full", children: [_jsx(Editor, { height: height, width: width, language: "json", theme: theme === 'dark' ? 'vs-dark' : 'vs-light', value: value, onChange: handleEditorChange, onMount: handleEditorDidMount, options: {
                    readOnly: disabled,
                ...
                } }), !isValid && !disabled && (_jsx("div", { className: "absolute right-2 bottom-2 rounded bg-red-500 px-2 py-1 text-white text-xs", children: "Invalid JSON" }))] }));
}
