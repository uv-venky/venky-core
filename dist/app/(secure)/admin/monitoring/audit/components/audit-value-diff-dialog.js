...
export function AuditValueDiffDialog({ store, rowId, onClose }) {
    ...
    return (_jsx(Popup, { title: "Value diff", description: meta.description, onClose: onClose, width: 1220, height: 640, minWidth: 520, minHeight: 360, bodyClassName: "flex min-h-0 flex-1 flex-col overflow-hidden pb-4", children: _jsx("div", { className: "min-h-0 flex-1 overflow-hidden rounded-md border border-border/60", children: _jsx(DiffEditor, { height: "100%", language: meta.language, theme: theme === 'dark' ? 'vs-dark' : 'vs-light', original: meta.oldText, modified: meta.newText, options: {
                    readOnly: true,
