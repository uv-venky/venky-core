...
import { canShowAuditValueDiff, getAuditChangeType, } from '../../../../../../app/(secure)/admin/monitoring/audit/lib/audit-value-diff';
...
function TimestampCell({ store, rowId }) {
    ...
    return (_jsx("div", { className: "min-w-0 max-w-full", children: _jsx("div", { className: "truncate text-muted-foreground text-xs", title: relativeTime, children: relativeTime }) }));
}
function UserCell({ store, rowId }) {
    ...
    return (_jsxs("div", { className: "flex min-w-0 max-w-full items-center gap-2", children: [_jsx("div", { className: "flex size-6 shrink-0 items-center justify-center rounded-full bg-muted", children: _jsx(User, { className: "size-3 text-muted-foreground" }) }), _jsx("span", { className: "truncate text-sm", title: updatedBy, children: updatedBy })] }));
}
function ChangeTypeCell({ store, rowId }) {
    ...
    return (_jsxs(Badge, { variant: "outline", className: cn('gap-1 border font-normal', config.bgColor, config.color), children: [_jsx(Icon, { className: "size-3" }), config.label] }));
}
        ...
        const columns = [
            {
                ...
                meta: { label: 'ID' },
                size: 80,
                header: (props) => _jsx(HeaderCell, { ...props, type: "Number", store: store, accessorKey: "auditId", title: "ID" }),
            ...
            },
            {
                ...
                size: 160,
                header: (props) => (_jsx(HeaderCell, { ...props, type: "Date", store: store, accessorKey: "updatedAt", title: "Timestamp" })),
            ...
            },
            {
                ...
                meta: { label: 'User' },
                size: 120,
                header: (props) => _jsx(HeaderCell, { ...props, type: "Text", store: store, accessorKey: "updatedBy", title: "User" }),
            ...
            },
            {
                ...
                size: 160,
                header: (props) => (_jsx(HeaderCell, { ...props, type: "Text", store: store, accessorKey: "datasourceId", title: "Data Source" })),
            ...
            },
            {
                ...
                meta: { label: 'PK Value' },
                size: 140,
                header: (props) => _jsx(HeaderCell, { ...props, type: "Text", store: store, accessorKey: "pkValue", title: "PK Value" }),
            ...
            },
            {
                ...
                size: 140,
                header: (props) => (_jsx(HeaderCell, { ...props, type: "Text", store: store, accessorKey: "attributeCode", title: "Attribute" })),
            ...
            },
            {
                ...
                meta: { label: 'Type' },
                size: 100,
                header: (props) => _jsx(HeaderCell, { ...props, type: "Text", store: store, accessorKey: "valueType", title: "Type" }),
