...
export declare function getJobHistoryAction(client: PgPoolClient, _session: Session, jobName: string): Promise<JobHistoryResult>;
export declare function triggerJobAction(_client: PgPoolClient, session: Session, jobName: string): Promise<TriggerJobResult>;
