...
function StatusBadge({ status }) {
  if (status === 'online') {
    return _jsxs(Badge, {
      variant: 'outline',
      className:
        'gap-1 border-emerald-200 bg-emerald-50 text-emerald-700 dark:border-emerald-800 dark:bg-emerald-950 dark:text-emerald-400',
      children: [_jsx('span', { className: 'h-1.5 w-1.5 animate-pulse rounded-full bg-emerald-500' }), 'Online'],
    });
  }
  if (status === 'offline') {
    return _jsx(Badge, {
    ...
    children: [
      _jsxs('button', {
        ...
        children: [
          ...
          _jsx(Server, { className: 'h-4 w-4 text-muted-foreground' }),
          _jsx('span', { className: 'font-semibold text-sm', children: 'Scheduler Nodes' }),
          _jsxs('span', {
            ...
            children: [
              _jsxs('span', {
                ...
                children: [
                  _jsx('span', { className: 'h-1.5 w-1.5 rounded-full bg-emerald-500' }),
                  data.onlineCount,
                  ' online',
                ],
              }),
        ...
        _jsxs('div', {
          children: [
            _jsx('div', {
              ...
              children: _jsxs('div', {
                className:
                  'grid grid-cols-[1fr_8rem_4rem_5rem_7rem_7rem_4rem_4rem_8rem] items-center gap-3 font-semibold text-muted-foreground text-xs uppercase tracking-wider',
                children: [
                  _jsx('div', { children: 'Node' }),
                  _jsx('div', { children: 'Scheduler ID' }),
                  _jsx('div', { children: 'PID' }),
                  _jsx('div', { children: 'Status' }),
                  _jsx('div', { children: 'Started' }),
                  _jsx('div', { children: 'Last Seen' }),
                  _jsx('div', { children: 'CPU' }),
                  _jsx('div', { children: 'Mem' }),
                  _jsx('div', { children: 'Jobs' }),
                ],
              }),
            }),
            _jsx('div', {
                  ...
                  'div',
                  {
                    ...
                    children: [
                      _jsxs('div', {
                        ...
                        children: [
                          _jsx(HardDrive, { className: 'h-3.5 w-3.5 shrink-0 text-muted-foreground' }),
                          _jsx('span', {
                      ...
                      _jsx('div', {
                        ...
                        title: node.schedulerId,
                        children: node.schedulerId,
                      }),
                      _jsx('div', { className: 'text-muted-foreground text-xs', children: node.pid }),
                      _jsx('div', { children: _jsx(StatusBadge, { status: node.status }) }),
                      _jsx('div', {
                        className: 'text-muted-foreground text-xs',
                        title: node.startedAt,
                        children: formatTimeAgo(node.startedAt),
                      }),
                      _jsx('div', {
                        className: 'text-muted-foreground text-xs',
                        title: node.lastSeenAt,
                      ...
                      _jsx('div', {
                        className: 'text-muted-foreground text-xs',
                        children: node.memoryMb != null ? `${node.memoryMb}M` : '-',
                      }),
                      _jsxs('div', {
                        className: 'text-muted-foreground text-xs',
                        'data-tip': `Scheduled: ${node.jobsScheduled}, Running: ${node.jobsRunning}, Executed: ${node.jobsExecuted}`,
                        'data-tip-at': 'left',
                        children: [node.jobsScheduled, '/', node.jobsRunning, '/', node.jobsExecuted],
                      }),
                    ],
                  },
