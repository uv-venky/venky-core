...
export default function UserActivityHistoryPageContent() {
    ...
    return (_jsx(PageLayoutTemplate, { title: "User Activity History", subTitle: "Summarized daily page views by user", icon: _jsx(Clock, { className: "h-12 w-12 text-muted-foreground" }), store: store, smartSearchColumns: smartSearchColumns, tableColumns: tableColumns, pageId: "user-activity-history-page", itemId: "user-activity-history", defaultVisibleColumnOrder: defaultVisibleColumnOrder, searchOnBlur: true, showExportButton: true, exportFilename: "user-activity-history" }));
}
