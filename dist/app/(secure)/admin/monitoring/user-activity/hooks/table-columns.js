    ...
    children: [
      ...
      _jsx(Dialog, {
        ...
        children: _jsxs(DialogContent, {
          className: 'w-[800px] sm:max-w-auto',
          children: [
            _jsx(DialogHeader, { children: _jsx(DialogTitle, { children: 'Metadata' }) }),
            _jsx(JsonPreview, { value: value, theme: theme === 'dark' ? 'dark' : 'light' }),
          ],
        }),
      }),
    ],
...
function ActivityCell(props) {
  ...
  return _jsxs(Cell, {
    ...
    children: [
      attributeCode === 'eventId' && _jsx(MetadataInfo, { rowId: row.id }),
      _jsx(Button, {
        variant: 'link',
        size: 'sm',
