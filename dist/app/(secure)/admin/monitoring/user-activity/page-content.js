...
const defaultVisibleColumnOrder = ['createdAt', 'userName', 'trackId', 'eventType', 'eventId', 'dataSource', 'pageUrl'];
export default function UserActivityPageContent() {
  ...
  return _jsx(PageLayoutTemplate, {
    ...
    icon: _jsx(Activity, { className: 'h-12 w-12 text-muted-foreground' }),
    store: store,
