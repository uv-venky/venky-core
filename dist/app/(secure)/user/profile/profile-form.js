      ...
      _jsxs(CardHeader, {
        children: [
          ...
          _jsx(CardDescription, {
            children: 'Update your profile information and how others see you on the platform.',
          }),
        ],
      }),
      _jsxs(CardContent, {
        ...
        children: [
          _jsxs('div', {
            className: 'flex flex-col items-center space-y-4 sm:flex-row sm:space-x-6 sm:space-y-0',
            children: [
              _jsxs('div', {
                className: 'relative',
                children: [
                  _jsxs(Avatar, {
                    className: 'h-32 w-32',
                    children: [
                      _jsx(AvatarImage, { src: avatar, alt: 'Profile picture' }),
                      _jsx(AvatarFallback, { children: session.name.charAt(0) }),
                    ],
                  }),
                  _jsx('div', {
                    className:
                      'absolute -right-2 -bottom-2 rounded-full bg-primary p-0 text-primary-foreground shadow-sm',
                    children: _jsx(Button, {
                      ...
                      children: _jsx(Camera, { className: 'h-4 w-4' }),
                    }),
                  }),
                ],
              }),
              _jsxs('div', {
                className: 'space-y-2',
                children: [
                  _jsx('h3', { className: 'font-medium text-lg', children: 'Profile Picture' }),
                  _jsx('p', {
                    className: 'text-muted-foreground text-sm',
                    children: 'Upload a new profile picture. Recommended size: 256x256px.',
                  }),
                  _jsxs('div', {
                    ...
                    children: [
                      _jsxs(Button, {
                        ...
                        children: [_jsx(Upload, { className: 'mr-2 h-4 w-4' }), 'Upload New'],
                      }),
                      _jsx(Button, {
                        variant: 'outline',
                        size: 'sm',
          ...
          _jsxs('div', {
            ...
            children: [
              _jsx(TextInput, { label: 'Display Name', value: session.name, disabled: true, labelOnTop: true }),
              _jsx(TextInput, {
                label: 'Job Title',
              ...
              _jsx(TextInput, {
                ...
                helpText: _jsx('span', {
                  ...
                  children: 'Contact IT support to change your email address.',
                }),
              }),
              _jsx(TextInput, {
                label: 'Department',
