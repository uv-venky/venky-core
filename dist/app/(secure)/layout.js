...
const CustomMiniLogo = ({ className, fill = 'var(--logo)' }) => (_jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", "aria-hidden": "true", className: cn(className, 'size-6 shrink-0'), children: _jsx("text", { x: "12", y: "16.8", textAnchor: "middle", fontFamily: "ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial", fontSize: "14.5", fontWeight: "700", fill: fill, children: "W" }) }));
