...
export default function AppThemeProvider({ children, nonce, className }) {
  ...
  return _jsx('html', {
    ...
    children: _jsxs('body', {
      className: `h-screen max-h-screen overflow-auto antialiased`,
      children: [
        _jsx(InitNextJSCoreHooksSetup, {}),
        _jsx(SetupHashListener, {}),
        _jsxs(ThemeProvider, {
          nonce: nonce,
          attribute: 'class',
          defaultTheme: theme,
          ...
          children: [children, _jsx(ToasterComponent, {}), _jsx('div', { id: 'tooltip' }), _jsx(GlobalTooltip, {})],
        }),
      ],
    }),
  });
