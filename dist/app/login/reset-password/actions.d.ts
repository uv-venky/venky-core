import type { ChangePasswordWithResetTokenInput, PasswordResetRequestInput, Result, ValidPasswordResetTokenType } from '../../../app/login/reset-password/types';
export declare const requestPasswordReset: (_prev: Result | undefined, formData: FormData) => Promise<import("../../../venky-exports/core/common").ErrorResponse | Result>;
...
export declare function validatePasswordResetTokenValue(encodedToken: string): Promise<false | ValidPasswordResetTokenType>;
