...
export function GoogleLoginPage() {
    ...
    if (error) {
        return (_jsxs("div", { className: "flex h-screen flex-col items-center justify-center gap-4 bg-background", children: [_jsx("div", { className: "text-destructive", children: error }), _jsx(Link, { href: "/login", className: "text-primary underline", children: "Return to login" })] }));
    }
    return (_jsxs("div", { className: "flex h-screen items-center justify-center bg-background text-foreground", children: [_jsx(Loader2, { className: "mr-4 animate-spin" }), "Signing in with Google..."] }));
}
