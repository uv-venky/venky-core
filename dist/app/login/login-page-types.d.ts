...
export declare const DEFAULT_LOGIN_TABS: LoginTabConfig[];
...
export declare const DEFAULT_LOGIN_LEGAL_NOTICE: LoginLegalNoticeConfig;
...
//# sourceMappingURL=login-page-types.d.ts.map