export function get_json_schema_type(attr) {
  switch (attr.type) {
    case 'Text':
...
export function get_json_schema_filter_type(attr) {
  switch (attr.type) {
    case 'Text':
      return `StringFilter`;
    case 'Date':
...
export function get_json_default_value(attr) {
  switch (attr.type) {
    case 'Text':
...
//# sourceMappingURL=json-schema-utils.js.map
