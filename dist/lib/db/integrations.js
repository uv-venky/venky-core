 ...
 */
export async function decryptConfig(encryptedConfig) {
  try {
 ...
 */
export async function getIntegration(integrationId, userName) {
  return await transaction(async (client) => {
    ...
    return {
      ...
      name: row.name,
      type: row.type,
      config: await decryptConfig(row.config),
 ...
 */
export async function createIntegration(userName, name, type, config) {
  return await transaction(async (client) => {
 ...
 */
export async function updateIntegration(integrationId, userName, updates) {
  return await transaction(async (client) => {
    ...
    return {
      ...
      name: updated.name,
      type: updated.type,
      config: updates.config || (await decryptConfig(updated.config)),
 ...
 */
export async function deleteIntegration(integrationId, userName) {
  return await transaction(async (client) => {
    const result = await client.query(
      `
 ...
 */
export function extractIntegrationIds(nodes) {
 ...
 */
export async function validateWorkflowIntegrations(nodes, userName) {
