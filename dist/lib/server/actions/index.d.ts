...
export declare const ACTIONS: {
  getUserSession: (
    ...
    _session: Session,
  ) => Promise<import('../../core/common/types/UserSession').UserSession | null>;
  getEnvironment: (
    _client: PgPoolClient,
    _session: Session,
  ) => Promise<import('../../../app/(secure)/EnvProvider').Env>;
  getAppConfigForDevtools: (
    _client: PgPoolClient,
    _session: Session,
  ) => Promise<Omit<import('../../core/server/config').AppConfig, 'secret'>>;
  ...
  createComment: (
    ...
    context: string,
    contextId: string,
    comment: import('../../../types/comments').NewComment,
  ) => Promise<import('../../../types/comments').Comment>;
  ...
  getActivityEvents: (
    client: PgPoolClient,
    session: Session,
    filters: import('../../../app/(secure)/admin/monitoring/activity/data').ActivityFilters,
  ) => Promise<import('../../core/common/types/Activity').Activity[]>;
  getAuditStats: (
    client: PgPoolClient,
    session: Session,
  ) => Promise<import('../../../app/(secure)/admin/monitoring/audit/actions').AuditStats>;
  getAuditFilterOptions: (
    client: PgPoolClient,
    session: Session,
  ) => Promise<import('../../../app/(secure)/admin/monitoring/audit/actions').AuditFilterOptions>;
  updateProfile: <K extends keyof import('../../core/common/types/UserSettings').UserSettings>(
    client: PgPoolClient,
    session: Session,
    key: K,
    value: import('../../core/common/types/UserSettings').UserSettings[K],
  ) => Promise<{
    status: 'OK' | 'ERROR';
    message?: string;
  }>;
