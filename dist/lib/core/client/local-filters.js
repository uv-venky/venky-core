    ...
    case 'Reference': {
      ...
      switch (operator) {
        ...
        case 'notany':
          ...
          break;
        case 'slt':
          val = ignoreCase ? recordValue.toLowerCase() < value.toLowerCase() : recordValue < value;
          break;
        case 'sgt':
          val = ignoreCase ? recordValue.toLowerCase() > value.toLowerCase() : recordValue > value;
          break;
    ...
    case 'Number':
      switch (operator) {
        ...
        case 'lte':
          ...
          break;
        case 'bn':
          val = record[key] >= value?.[0] && record[key] <= value?.[1];
          break;
        case 'in':
    ...
    case 'Date': {
      ...
      switch (operator) {
        ...
        case 'last7days':
          ...
          val = recordDate >= parseISO(formatISO(range[0])) && recordDate <= parseISO(formatISO(range[1]));
          break;
        case 'last14days':
