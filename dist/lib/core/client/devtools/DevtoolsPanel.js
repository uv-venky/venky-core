...
function HttpStatusBadge({ status }) {
  ...
  return _jsx('span', {
    className: `rounded px-2 py-0.5 font-medium font-mono text-xs ${colorClass}`,
    children: status,
  });
}
function MethodBadge({ method }) {
  ...
  return _jsx('span', {
    className: `font-mono font-semibold text-xs ${colors[method] || 'text-gray-400'}`,
    children: method,
  });
}
function SlowIndicator({ duration, threshold }) {
  ...
  return _jsx('span', {
    ...
    'data-tip': `Slow operation (>${threshold}ms)`,
    children: _jsx(AlertTriangle, { className: 'size-3' }),
  });
}
function CopyButton({ data }) {
  ...
  return _jsx('button', {
    ...
    children: copied ? _jsx(Check, { className: 'size-3 text-green-400' }) : _jsx(Copy, { className: 'size-3' }),
  });
}
function DataInspector({ data, label }) {
  ...
  return _jsxs('div', {
    className: 'mt-2 rounded bg-gray-800/50 text-xs',
    children: [
      _jsxs('div', {
        className: 'flex w-full items-center justify-between p-2 text-gray-400',
        children: [
          _jsxs('button', {
            type: 'button',
            ...
            children: [
              expanded ? _jsx(ChevronDown, { className: 'size-3' }) : _jsx(ChevronRight, { className: 'size-3' }),
              label || 'Data',
            ],
          }),
          _jsx(CopyButton, { data: data }),
        ],
      }),
      expanded &&
        _jsx('div', {
          className:
            'scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-800 max-h-48 overflow-auto border-gray-700 border-t p-2 font-mono text-[11px]',
          children: _jsx(JsonTreeProvider, {
            children: _jsx(JsonTreeValue, {
              value: data,
              theme: 'dark',
...
function SearchFilter() {
  ...
  return _jsxs('div', {
    className: 'relative',
    children: [
      _jsx(Filter, { className: 'absolute top-1/2 left-2 size-3.5 -translate-y-1/2 text-gray-500' }),
      _jsx('input', {
        type: 'text',
        value: snap.filter,
        ...
        placeholder: 'Filter...',
        className:
          'w-full rounded border border-gray-700 bg-gray-800 py-1.5 pr-2 pl-7 text-gray-200 text-xs placeholder:text-gray-500 focus:border-blue-500 focus:outline-none',
      }),
      snap.filter &&
        _jsx('button', {
          type: 'button',
          ...
          children: _jsx(X, { className: 'size-3' }),
        }),
    ],
  });
}
function EnvironmentBadge() {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('span', { className: `rounded px-1.5 py-0.5 font-medium ${envColor}`, children: env.nodeEnv }),
      env.appVersion && _jsxs('span', { className: 'text-gray-500', children: ['v', env.appVersion] }),
    ],
  });
}
function TabButton({ active, onClick, children, icon: Icon, count }) {
  return _jsxs('button', {
    type: 'button',
    onClick: onClick,
    className: `relative flex items-center gap-1.5 rounded px-3 py-1.5 font-medium text-sm transition-colors ${active ? 'bg-blue-500/20 text-blue-400' : 'text-gray-400 hover:bg-gray-700/50 hover:text-gray-200'}`,
    children: [
      _jsx(Icon, { className: 'size-4' }),
      children,
      count !== undefined &&
        count > 0 &&
        _jsx('span', {
          className: 'ml-1 rounded-full bg-gray-700 px-1.5 py-0.5 font-medium text-[10px] text-gray-300',
          children: count,
        }),
    ],
  });
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          expanded
            ? _jsx(ChevronDown, { className: 'size-3 shrink-0 text-gray-500' })
            : _jsx(ChevronRight, { className: 'size-3 shrink-0 text-gray-500' }),
          _jsx('span', { className: 'font-medium text-gray-200', children: store.datasourceId }),
          _jsxs('span', {
            className: 'truncate text-gray-500 text-xs',
            children: [store.alias, ' \u00B7 ', store.page],
          }),
          _jsxs('span', { className: 'shrink-0 text-gray-600 text-xs', children: ['(', store.rowCount, ')'] }),
          store.lastQueryAt &&
            _jsx('span', { className: 'shrink-0 text-gray-600 text-xs', children: formatTime(store.lastQueryAt) }),
          _jsxs('div', {
            ...
            children: [
              ...
              store.isLoading && _jsx(StatusBadge, { status: 'loading' }),
              store.isPosting && _jsx(StatusBadge, { status: 'pending' }),
              store.isDirty &&
                _jsxs('span', {
                  className: 'rounded bg-orange-500/20 px-1.5 py-0.5 font-medium text-[10px] text-orange-400',
                  children: ['dirty (', store.dirtyRowCount, ')'],
                }),
            ],
          }),
        ],
      ...
      expanded &&
        _jsxs('div', {
          className: 'border-gray-700/50 border-t bg-gray-800/30 px-3 py-2 pl-8',
          children: [
            _jsxs('div', {
              className: 'space-y-0.5 text-gray-500 text-xs',
              children: [
                _jsxs('div', {
                  children: [
                    'Alias: ',
                    _jsx('span', { className: 'text-gray-400', children: store.alias }),
                    ' | Page:',
                    ' ',
                    _jsx('span', { className: 'text-gray-400', children: store.page }),
                  ],
                }),
                _jsxs('div', {
                  children: ['Rows: ', _jsx('span', { className: 'text-gray-400', children: store.rowCount })],
                }),
                store.lastQueryAt &&
                  _jsxs('div', {
                    children: [
                      'Last query: ',
                      _jsx('span', { className: 'text-gray-400', children: formatTime(store.lastQueryAt) }),
                    ],
                  }),
                store.lastSaveAt &&
                  _jsxs('div', {
                    children: [
                      'Last save: ',
                      _jsx('span', { className: 'text-gray-400', children: formatTime(store.lastSaveAt) }),
                    ],
                  }),
              ],
            }),
            store.query && _jsx(DataInspector, { data: store.query, label: 'Query' }),
            hasInitialRows &&
              _jsx(DataInspector, {
                data: store.rows,
            ...
            hasCurrentRows &&
              rowsAreDifferent &&
              _jsx(DataInspector, { data: currentRows, label: `Rows (current) - ${currentRowCount}` }),
            !hasInitialRows &&
              hasCurrentRows &&
              _jsx(DataInspector, { data: currentRows, label: `Rows (current) - ${currentRowCount}` }),
          ],
...
function StoresTab() {
  ...
  if (filteredStores.length === 0) {
    return _jsxs('div', {
      ...
      children: ['No stores match filter "', snap.filter, '"'],
    });
  }
  return _jsx('div', {
    className: 'divide-y divide-gray-700',
    children: filteredStores.map((store) => _jsx(StoreItem, { store: store }, store.key)),
  });
}
function QueriesTab() {
  const snap = useSnapshot(devtoolsStore);
  ...
  if (filteredQueries.length === 0) {
    return _jsxs('div', {
      className: 'p-4 text-gray-500 text-sm',
      children: ['No queries match filter "', snap.filter, '"'],
    });
  }
  return _jsx('div', {
    className: 'divide-y divide-gray-700',
    children: filteredQueries.map((query) => _jsx(QueryItem, { query: query }, query.key)),
  });
}
      ...
      _jsxs('button', {
        ...
        children: [
          expanded
            ? _jsx(ChevronDown, { className: 'size-3 shrink-0 text-gray-500' })
            : _jsx(ChevronRight, { className: 'size-3 shrink-0 text-gray-500' }),
          _jsx('span', { className: 'font-medium text-gray-200', children: query.actionName }),
          query.dataUpdatedAt &&
            _jsx('span', { className: 'text-gray-600 text-xs', children: formatTime(query.dataUpdatedAt) }),
          _jsx('div', {
            className: 'ml-auto flex shrink-0 items-center gap-2',
            children: _jsx(StatusBadge, { status: query.status }),
          }),
        ],
      }),
      expanded &&
              ...
              children: [
                query.dataUpdatedAt &&
                  _jsxs('div', {
                    children: [
                      'Updated: ',
                      _jsx('span', { className: 'text-gray-400', children: formatTime(query.dataUpdatedAt) }),
                    ],
                  }),
                query.error && _jsxs('div', { className: 'text-red-400', children: ['Error: ', query.error] }),
              ],
            }),
            query.params.length > 0 && _jsx(DataInspector, { data: query.params, label: 'Params' }),
            query.data !== undefined && _jsx(DataInspector, { data: query.data, label: 'Response Data' }),
          ],
        }),
    ],
  });
      ...
      _jsxs('button', {
        ...
        children: [
          expanded
            ? _jsx(ChevronDown, { className: 'size-3 shrink-0 text-gray-500' })
            : _jsx(ChevronRight, { className: 'size-3 shrink-0 text-gray-500' }),
          _jsx('span', { className: 'font-medium text-gray-200', children: mutation.name }),
          _jsx('span', { className: 'text-gray-600 text-xs', children: formatTime(mutation.startedAt) }),
          _jsxs('div', {
            className: 'ml-auto flex shrink-0 items-center gap-2',
            children: [
              _jsx(SlowIndicator, { duration: mutation.duration, threshold: slowThreshold }),
              _jsx(StatusBadge, { status: mutation.status }),
              _jsx('span', { className: 'text-gray-500 text-xs', children: formatDuration(mutation.duration) }),
            ],
          }),
        ],
      }),
            ...
            _jsxs('div', {
              ...
              children: [
                _jsxs('div', {
                  children: [
                    'Started: ',
                    _jsx('span', { className: 'text-gray-400', children: formatTime(mutation.startedAt) }),
                  ],
                }),
                mutation.error && _jsxs('div', { className: 'text-red-400', children: ['Error: ', mutation.error] }),
                mutation.invalidatedQueries &&
                  mutation.invalidatedQueries.length > 0 &&
                  _jsxs('div', {
                    className: 'flex items-center gap-1',
                    children: [
                      _jsx(RefreshCw, { className: 'size-3' }),
                      'Invalidated: ',
                      mutation.invalidatedQueries.join(', '),
                    ],
                  }),
              ],
            }),
            mutation.params && _jsx(DataInspector, { data: mutation.params, label: 'Params' }),
            mutation.result !== undefined && _jsx(DataInspector, { data: mutation.result, label: 'Result' }),
          ],
        }),
    ],
  });
...
function MutationsTab() {
  ...
  if (filteredMutations.length === 0) {
    return _jsxs('div', {
      className: 'p-4 text-gray-500 text-sm',
      children: ['No mutations match filter "', snap.filter, '"'],
    });
  }
  return _jsx('div', {
    className: 'divide-y divide-gray-700',
    children: filteredMutations.map((mutation) =>
      _jsx(MutationItem, { mutation: mutation, slowThreshold: snap.slowThreshold }, mutation.id),
    ),
  });
}
...
function ActivityTab() {
  ...
  if (filteredActivity.length === 0) {
    return _jsxs('div', {
      className: 'p-4 text-gray-500 text-sm',
      children: ['No activity matches filter "', snap.filter, '"'],
    });
  }
  return _jsx('div', {
    className: 'divide-y divide-gray-700',
    children: filteredActivity.map((entry) => {
      ...
      return _jsx(
        'div',
        {
          className: 'p-2 text-xs hover:bg-gray-800/50',
          children: _jsxs('div', {
            className: 'flex items-center gap-2',
            children: [
              _jsx('span', {
                className: `font-medium ${activityTypeColors[entry.type] || 'text-gray-400'}`,
                children: entry.type,
              }),
              networkEntry && _jsx(NetworkTypeBadge, { type: networkEntry.type }),
              _jsxs('span', {
                className: 'flex-1 truncate text-gray-300',
                children: [
                  entry.name,
                  context && _jsxs('span', { className: 'ml-1 text-cyan-400', children: ['(', context, ')'] }),
                ],
              }),
              _jsx(SlowIndicator, { duration: entry.duration, threshold: snap.slowThreshold }),
              _jsx(StatusBadge, { status: entry.status }),
              _jsx('span', { className: 'text-gray-500', children: formatDuration(entry.duration) }),
            ],
          }),
        },
        entry.id,
    ...
    children: [
      _jsxs('button', {
        ...
        children: [
          expanded
            ? _jsx(ChevronDown, { className: 'size-3 shrink-0 text-gray-500' })
            : _jsx(ChevronRight, { className: 'size-3 shrink-0 text-gray-500' }),
          _jsx(NetworkTypeBadge, { type: entry.type }),
          _jsx(MethodBadge, { method: entry.method }),
          _jsxs('span', {
          ...
          _jsxs('div', {
            ...
            children: [
              ...
              _jsx(SlowIndicator, { duration: entry.duration, threshold: slowThreshold }),
              entry.statusCode
                ? _jsx(HttpStatusBadge, { status: entry.statusCode })
                : _jsx(StatusBadge, { status: entry.status }),
              _jsx('span', { className: 'text-gray-500 text-xs', children: formatDuration(entry.duration) }),
              _jsx('span', { className: 'text-gray-600 text-xs', children: formatTime(entry.startedAt) }),
            ],
          }),
        ],
      }),
      expanded &&
        _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              className: 'flex flex-wrap items-center gap-3 text-gray-500 text-xs',
              children: [
                _jsxs('span', { children: ['Started: ', formatTime(entry.startedAt)] }),
                entry.duration !== undefined &&
                  _jsxs('span', { children: ['Duration: ', formatDuration(entry.duration)] }),
                entry.responseSize !== undefined &&
                  entry.responseSize > 0 &&
                  _jsxs('span', { children: ['Size: ', formatBytes(entry.responseSize)] }),
                entry.type === 'server-action' &&
                  entry.actionName &&
                  _jsxs('span', {
                    className: 'font-mono text-purple-400/70',
                    'data-tip': `Action ID: ${entry.actionName}`,
                    children: ['Action ID: ', entry.actionName],
                  }),
                entry.error && _jsxs('span', { className: 'text-red-400', children: ['Error: ', entry.error] }),
              ],
            }),
            entry.requestBody !== undefined && _jsx(DataInspector, { data: entry.requestBody, label: 'Request Body' }),
            entry.responseBody !== undefined &&
              _jsx(DataInspector, { data: entry.responseBody, label: 'Response Body' }),
          ],
        }),
    ],
  });
...
function NetworkTab() {
  ...
  if (network.length === 0) {
    return _jsxs('div', {
      className: 'p-4 text-gray-500 text-sm',
      children: [
        _jsx('p', { children: 'No network requests recorded' }),
        _jsxs('p', {
          className: 'mt-2 text-xs',
          children: [
            'Tracks ',
            _jsx('code', { className: 'rounded bg-gray-800 px-1', children: '/api/*' }),
  ...
  if (filteredNetwork.length === 0) {
    return _jsxs('div', {
      className: 'p-4 text-gray-500 text-sm',
      children: ['No requests match filter "', snap.filter, '"'],
    });
  }
  return _jsx('div', {
    className: 'divide-y divide-gray-700',
    children: filteredNetwork.map((entry) =>
      _jsx(NetworkItem, { entry: entry, slowThreshold: snap.slowThreshold }, entry.id),
    ),
  });
}
function ErrorSourceBadge({ source }) {
  ...
  return _jsx('span', {
    className: `rounded px-1.5 py-0.5 font-medium text-[10px] ${colors[source] || colors.custom}`,
    children: source,
  });
}
function ErrorsTab() {
  ...
  if (errors.length === 0) {
    return _jsxs('div', {
      className: 'p-4 text-gray-500 text-sm',
      children: [
        _jsx('p', { children: 'No errors recorded' }),
        _jsx('p', {
          className: 'mt-2 text-xs',
          children: 'Errors from queries, mutations, network requests, and unhandled exceptions will appear here.',
        }),
      ],
    });
  }
  if (filteredErrors.length === 0) {
    return _jsxs('div', {
      className: 'p-4 text-gray-500 text-sm',
      children: ['No errors match filter "', snap.filter, '"'],
    });
  }
  return _jsx('div', {
    className: 'divide-y divide-gray-700',
    children: filteredErrors.map((entry) =>
      _jsxs(
        'div',
        {
          ...
          children: [
            _jsxs('div', {
              ...
              children: [
                _jsx(AlertCircle, { className: 'size-4 text-red-400' }),
                _jsx(ErrorSourceBadge, { source: entry.source }),
                _jsx('span', {
                  className: 'flex-1 truncate font-medium text-red-300 text-xs',
                  children: entry.message,
                }),
                _jsx('span', { className: 'text-gray-500 text-xs', children: formatTime(entry.timestamp) }),
              ],
            }),
            entry.url &&
              _jsxs('div', {
                className: 'mb-1 text-gray-500 text-xs',
                children: [_jsx('span', { className: 'text-gray-600', children: 'URL:' }), ' ', entry.url],
              }),
            entry.stack &&
              _jsxs('details', {
                className: 'mt-2',
                children: [
                  _jsx('summary', {
                    className: 'cursor-pointer text-gray-400 text-xs hover:text-gray-200',
                    children: 'Stack trace',
                  }),
                  _jsx('pre', {
                    className:
                      'mt-1 max-h-32 overflow-auto whitespace-pre-wrap rounded bg-gray-800/50 p-2 font-mono text-[10px] text-gray-400',
                    children: entry.stack,
                  }),
                ],
              }),
            entry.context && _jsx(DataInspector, { data: entry.context, label: 'Context' }),
          ],
        },
        entry.id,
      ),
...
function ConfigRow({ label, value }) {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('span', { className: 'min-w-[140px] font-medium text-gray-400 text-xs', children: label }),
      _jsx('span', {
        className: 'font-mono text-gray-200 text-xs',
        children: displayValue || _jsx('span', { className: 'text-gray-500', children: '-' }),
      }),
    ],
  });
}
function ConfigSection({ title, children }) {
  return _jsxs('div', {
    className: 'border-gray-700 border-b p-3',
    children: [
      _jsx('h3', { className: 'mb-2 font-semibold text-gray-300 text-sm', children: title }),
      _jsx('div', { className: 'space-y-0.5', children: children }),
    ],
  });
}
function ConfigTab() {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs(ConfigSection, {
        title: 'Environment',
        children: [
          _jsx(ConfigRow, { label: 'NODE_ENV', value: env.nodeEnv }),
          _jsx(ConfigRow, { label: 'App Version', value: env.appVersion }),
          _jsx(ConfigRow, { label: 'Current Path', value: env.pathname }),
        ],
      }),
      _jsxs(ConfigSection, {
        title: 'User Session',
        children: [
          _jsx(ConfigRow, { label: 'User Name', value: env.userName }),
          _jsx(ConfigRow, { label: 'Email', value: env.userEmail }),
          _jsx(ConfigRow, { label: 'Roles', value: env.userRoles }),
        ],
      }),
      env.env &&
        _jsxs('div', {
          className: 'p-3',
          children: [
            _jsx('h3', { className: 'mb-2 font-semibold text-gray-300 text-sm', children: 'Client Environment' }),
            _jsx('div', {
      ...
      hasConfig &&
        _jsxs('div', {
          className: 'p-3',
          children: [
            _jsx('h3', { className: 'mb-2 font-semibold text-gray-300 text-sm', children: 'App Config' }),
            _jsx('div', {
              className: 'font-mono text-xs',
              children: _jsx(JsonTreeProvider, {
                children: _jsx(JsonTreeValue, {
...
export function DevtoolsPanel() {
  ...
  return _jsxs('div', {
    ...
    children: [
      !isMaximized &&
        _jsx('div', {
          ...
          children: _jsxs('svg', {
            ...
            children: [
              _jsx('path', { d: 'M 2 14 L 14 2', stroke: 'currentColor', strokeWidth: '1.5', strokeLinecap: 'round' }),
              _jsx('path', { d: 'M 2 9 L 9 2', stroke: 'currentColor', strokeWidth: '1.5', strokeLinecap: 'round' }),
              _jsx('path', { d: 'M 2 4 L 4 2', stroke: 'currentColor', strokeWidth: '1.5', strokeLinecap: 'round' }),
            ],
          }),
        }),
      _jsxs('div', {
        className: 'flex items-center justify-between border-gray-700 border-b bg-gray-800 px-3 py-2',
        children: [
          _jsxs('div', {
            ...
            children: [
              _jsxs('div', {
                className: 'flex items-center gap-2',
                children: [
                  _jsx('div', { className: 'size-2 rounded-full bg-green-500' }),
                  _jsx('span', {
                    className: 'font-semibold text-gray-200 text-sm',
                    children: _jsx('span', { className: 'tracking-[0.2em]', children: 'VENKY' }),
                  }),
                ],
              }),
              _jsx(EnvironmentBadge, {}),
            ],
          }),
          _jsxs('div', {
            className: 'flex items-center gap-1',
            children: [
              ...
              clearFn &&
                _jsx('button', {
                  ...
                  className: 'cursor-pointer rounded p-1 text-gray-400 hover:bg-gray-700 hover:text-gray-200',
                  'data-tip': 'Clear Tab',
                  children: _jsx(Eraser, { className: 'size-4' }),
                }),
              _jsx('button', {
                type: 'button',
                ...
                children: isMaximized
                  ? _jsx(Minimize2, { className: 'size-4' })
                  : _jsx(Maximize2, { className: 'size-4' }),
              }),
              _jsx('button', {
                type: 'button',
      ...
      _jsxs('div', {
        className: 'flex flex-col gap-2 border-gray-700 border-b bg-gray-850 p-2',
        children: [
          _jsxs('div', {
            className: 'flex items-center gap-1',
            children: [
      ...
      _jsxs('div', {
        className: 'scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-800 flex-1 overflow-auto',
        children: [
          snap.activeTab === 'stores' && _jsx(StoresTab, {}),
          snap.activeTab === 'queries' && _jsx(QueriesTab, {}),
          snap.activeTab === 'mutations' && _jsx(MutationsTab, {}),
          snap.activeTab === 'activity' && _jsx(ActivityTab, {}),
          snap.activeTab === 'network' && _jsx(NetworkTab, {}),
          snap.activeTab === 'errors' && _jsx(ErrorsTab, {}),
          snap.activeTab === 'config' && _jsx(ConfigTab, {}),
        ],
      }),
    ],
  });
...
export function DevtoolsToggle() {
  ...
  return _jsxs('button', {
    ...
    className:
      'group fixed bottom-5 left-[64px] z-[9998] flex size-9 cursor-pointer items-center justify-center rounded-full bg-gray-900 font-sans text-gray-300 shadow-lg ring-1 ring-gray-700 transition-all hover:bg-gray-800 hover:ring-gray-600',
    'data-tip': tooltip,
    children: [
      _jsx(Wrench, { className: 'size-4 text-blue-400 transition-transform group-hover:rotate-12' }),
      pendingCount > 0 &&
        _jsx('span', {
          className:
            'absolute -top-1 -right-1 flex size-4 items-center justify-center rounded-full bg-yellow-500 font-bold text-[10px] text-gray-900',
      ...
      pendingCount === 0 &&
        ...
        _jsx('span', {
          className:
            'absolute -top-1 -right-1 flex size-4 items-center justify-center rounded-full bg-red-500 font-bold text-[10px] text-white',
          children: errorCount,
        }),
    ],
  });
