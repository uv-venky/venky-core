...
export async function exportDashboardPDF({ fileName = 'dashboard-report.pdf', coverTitle, dashboardRef, summary, sections, }) {
    ...
    try {
        ...
        const res = await fetch('/api/export-dashboard-pdf', {
            method: 'POST',
