...
export declare function sendEmailWithTemplate({ template, context, to, cc, subject, attachments, client, }: {
    template: string;
...
export declare function sendNewUserEmail({ email, userName, password, accountId, isInternal, client, }: {
    email: string;
    userName: string;
    password: string;
    accountId?: string;
...
export declare function bulkQueueNewUserEmails({ users, isInternal, client, }: {
    users: {
        email: string;
        userName: string;
        password: string;
...
export declare function sendPasswordResetEmail({ email, token, key, userName, client, }: {
    email: string;
    token: string;
    key: string;
    userName: string;
