...
export declare function createPasswordResetToken(client: PgPoolClient, email: string, userName: string): Promise<{
    key: string;
    token: string;
}>;
export declare function validatePasswordResetToken(client: PgPoolClient, key: string, token: string, email: string, userName: string): Promise<boolean>;
