import type { RequestContextProvider } from './request-context';
/**
 ...
 */
export declare const nextjsRequestContext: RequestContextProvider;
//# sourceMappingURL=request-context-nextjs.d.ts.map