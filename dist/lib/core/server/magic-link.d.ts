 ...
 */
export declare function generateMasterLink<T>(client: PgPoolClient, session: Session, params: GenerateMasterLinkParams<T>): Promise<GenerateMasterLinkResult>;
/**
 ...
 */
export declare function generateLoginLink<T>(client: PgPoolClient, masterToken: string, loginLinkTtlMinutes?: number): Promise<{
    loginLink: string;
    loginToken: string;
}>;
/**
 ...
 */
export declare function redeemLoginToken<T>(client: PgPoolClient, token: string): Promise<{
    userName: string;
    metadata: T;
    redirectUrl: string;
}>;
