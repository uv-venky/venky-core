...
export declare function parallelReadQueries<T extends readonly unknown[]>(
  ...queries: {
...
export declare const transactionWithRetry: <Output>(
  callback: (_client: pg.PoolClient) => Promise<Output>,
) => Promise<Output>;
...
export declare function withBlockingAdvisoryLock<T>(
  key: bigint,
  callback: (client: PgPoolClient) => Promise<T>,
): Promise<T>;
export {};
