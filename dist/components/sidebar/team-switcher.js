      ...
      children: _jsxs(DropdownMenu, {
        children: [
            ...
            children: _jsxs(SidebarMenuButton, {
              ...
              children: [
                _jsx('div', {
                  ...
                  children: _jsx(AppIcon, { icon: activeTeam.logo }),
                }),
                _jsx('div', {
                  className: 'grid flex-1 text-left text-sm leading-tight',
                  children: _jsx('span', { className: 'truncate font-medium', children: activeTeam.name }),
                }),
          ...
          _jsxs(DropdownMenuContent, {
            className:
              'scrollbar-hide max-h-screen w-(--radix-dropdown-menu-trigger-width) min-w-56 overflow-y-auto rounded-lg',
            align: 'start',
            side: isMobile ? 'bottom' : 'right',
            sideOffset: 4,
            children: [
              _jsx(DropdownMenuLabel, { className: 'text-muted-foreground text-xs', children: 'Applications' }),
              teams.map((team, _index) =>
                _jsx(TeamSwitcherItem, { team: team, setActiveTeam: setActiveTeam }, team.name),
              ),
            ],
          }),
        ],
