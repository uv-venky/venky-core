        ...
        children: [
          _jsx(CollapsibleTrigger, {
            ...
            children: _jsxs(SidebarMenuButton, {
              ...
              children: [
                group.icon && _jsx(AppIcon, { icon: group.icon }),
                _jsx('span', { children: group.title }),
                !isActive &&
                  _jsx(ChevronRight, {
                    className:
          ...
          _jsx(CollapsibleContent, {
            children: _jsx(SidebarMenuSub, {
              children: group.pages
                ...
                .map((page) => _jsx(PageMenuItem, { page: page, group: group, moduleMenu: moduleMenu }, page.title)),
            }),
          }),
        ],
      }),
...
export function ModuleNav({ module: moduleMenu }) {
  ...
  return _jsxs(SidebarGroup, {
    children: [
      _jsx(SidebarGroupLabel, { children: moduleMenu.title }),
      _jsx(SidebarMenu, {
        children: moduleMenu.pageGroups.map((group) =>
          _jsx(GroupNav, { module: moduleMenu, group: group }, group.title),
        ),
      }),
    ],
  });
        ...
        children: _jsxs('div', {
          ...
          children: [
            isPending
              ...
              : _jsx(AppIcon, { icon: page.icon ?? 'FileText' }),
            _jsx('span', { className: 'truncate group-data-[collapsible=icon]:hidden', children: page.title }),
          ],
        }),
      }),
    },
