  ...
  return _jsx(
    SidebarMenuItem,
    {
      children: _jsx(SidebarMenuButton, {
        ...
        isActive: isActive(),
        tooltip: item.title,
        'data-testid': `sidebar-nav${fullUrl}`,
        children: _jsxs(Link, {
          prefetch: false,
          href: href,
          onClick: (e) => {
          ...
          children: [
            isPending ? _jsx(Loader2, { className: 'size-4 animate-spin' }) : _jsx(AppIcon, { icon: item.icon }),
...
export function OneLevelNav({ team, title }) {
  ...
  return _jsxs(SidebarGroup, {
    children: [
      _jsx(SidebarGroupLabel, { children: title }),
      _jsx(SidebarMenu, {
        children: team.oneLevelNav
