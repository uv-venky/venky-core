...
function AppSidebar({ ...props }) {
  ...
  return _jsxs(Sidebar, {
    collapsible: 'icon',
    ...props,
    className: cn('group/sidebar', props.className),
    children: [
      _jsxs(SidebarHeader, {
        className: 'relative flex h-16 items-center justify-center',
        children: [
          _jsx(SidebarToggleButton, {}),
          activeTeam && _jsx(TeamSwitcher, { teams: teams, activeTeam: activeTeam, setActiveTeam: setActiveTeam }),
        ],
      }),
      _jsx(SidebarContent, {
        children:
          ...
          _jsxs('div', {
            ...
            children: [
              _jsx(OneLevelNav, { team: activeTeam, title: activeTeam.menuTitle ?? activeTeam.name }),
              DynamicSidebarContent && _jsx(DynamicSidebarContent, { activeTeam: activeTeam }),
              activeTeam.modules.map((module) => _jsx(ModuleNav, { module: module }, module.title)),
            ],
          }),
      }),
