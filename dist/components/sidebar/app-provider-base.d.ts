...
export interface AppContextValue {
  ...
  customSidebarIcons?: Record<
    keyof SidebarIconRegistry,
    ComponentType<{
      className?: string;
    }>
  >;
...
export declare function useDeployConfig(): {
  deployConfig: Partial<
    Record<
      import('../../lib/core/common/types/DeployConfig').DeployEnvironment,
      import('../../lib/core/common/types/DeployConfig').DeployConfig
    >
  >;
  awsRegion: string;
...
}: BaseAppProviderProps): import('react/jsx-runtime').JSX.Element;
