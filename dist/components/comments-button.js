    ...
    children: [
      _jsx(DrawerTrigger, {
        ...
        children: _jsxs(Button, {
          ...
          children: [
            _jsx(MessageCircle, { className: 'h-[1.2rem] w-[1.2rem]' }),
            _jsx('span', { className: 'sr-only', children: 'Comments' }),
          ],
        }),
      }),
      _jsxs(DrawerContent, {
        className: 'flex h-full w-2xl max-w-2xl flex-col',
        title: 'Page Comments',
        children: [
          _jsx(DrawerTitle, { className: 'sr-only', children: 'Page Comments' }),
          _jsx(Comments, {
            context: 'page',
            contextId: pathname,
            title: 'Page Comments',
