  ...
  return _jsxs(_Fragment, {
    children: [
      _jsxs(Button, {
        ...
        children: [
          isLoading && _jsx(Loader2, { className: 'h-[1.2rem] w-[1.2rem] animate-spin' }),
          _jsx('svg', {
            width: '24px',
            height: '24px',
            viewBox: '0 0 24 24',
            className: isLoading ? 'hidden' : '',
            children: _jsx('path', { ref: pathRef, d: paths.default.d, fill: paths.default.color }),
          }),
          _jsx('span', { className: 'sr-only', children: 'Share URL' }),
        ],
      }),
      _jsx(Dialog, {
        open: showUrlDialog,
        ...
        children: _jsxs(DialogContent, {
          ...
          children: [
            _jsxs(DialogHeader, {
              children: [
                _jsx(DialogTitle, { children: 'Share URL' }),
                _jsx(DialogDescription, { children: 'Copy the URL below to share it with others' }),
              ],
            }),
            _jsxs('div', {
              className: 'mt-4',
              children: [
                ...
                _jsx('p', {
                  ...
                  children: 'Tap the text above to select all, then copy and paste it anywhere.',
                }),
              ],
            }),
          ],
