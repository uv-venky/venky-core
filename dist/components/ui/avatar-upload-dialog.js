            ...
            children: [
              _jsxs('div', {
                ...
                children: [
                  ...
                  _jsx('div', {
                    className:
                      'pointer-events-none absolute top-1/2 left-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-md border-2 border-primary',
                    'aria-hidden': 'true',
                  }),
                ],
              }),
              _jsx(Slider, { min: 1, max: 3, step: 0.1, value: [scale], onValueChange: (v) => setScale(v[0]) }),
            ],
          }),
        _jsxs(DialogFooter, {
          children: [
            _jsx(Button, { variant: 'outline', onClick: () => onOpenChange(false), children: 'Cancel' }),
            imageSrc && _jsx(Button, { onClick: handleSave, children: 'Save' }),
          ],
        }),
      ],
    }),
