...
declare function MenubarRadioGroup({
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.RadioGroup>): import('react/jsx-runtime').JSX.Element;
...
declare function MenubarCheckboxItem({
  ...
  checked,
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.CheckboxItem>): import('react/jsx-runtime').JSX.Element;
...
declare function MenubarSubContent({
  className,
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.SubContent>): import('react/jsx-runtime').JSX.Element;
export {
  Menubar,
  MenubarPortal,
  MenubarMenu,
