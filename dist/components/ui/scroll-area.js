  ...
  return _jsxs(ScrollAreaPrimitive.Root, {
    ...
    children: [
      _jsx(ScrollAreaPrimitive.Viewport, {
        ...
        className:
          'size-full rounded-[inherit] outline-ring/50 ring-ring/10 transition-[color,box-shadow] focus-visible:outline-1 focus-visible:ring-4 dark:outline-ring/40 dark:ring-ring/20',
        children: children,
      }),
      _jsx(ScrollBar, {}),
