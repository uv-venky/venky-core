...
export function NewPasswordForm({ token }) {
  ...
  if (state && state.status === 'OK') {
    return _jsxs(Card, {
      children: [
        _jsx(CardHeader, { children: _jsx(CardTitle, { children: 'Password changed' }) }),
        _jsxs(CardContent, {
          className: 'flex flex-col space-y-4',
          children: [
            _jsx('span', { children: 'Your password has been changed successfully.' }),
            _jsxs(Link, {
              prefetch: false,
              href: '/login',
              className: 'item-center flex text-primary text-sm hover:underline',
              children: ['Login ', _jsx(ArrowRight, { className: 'ml-2 h-4 w-4' })],
            }),
          ],
        }),
      ],
          ...
          _jsxs(CardContent, {
            ...
            children: [
              _jsx('div', {
                ...
                children: _jsx('span', {
                  className: 'mx-auto font-title-light text-3xl',
              ...
              _jsx('input', { type: 'hidden', name: 'token', value: token }),
            ],
          }),
          _jsx(CardFooter, {
