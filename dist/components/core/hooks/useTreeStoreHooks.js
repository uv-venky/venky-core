...
export function useIsStartEnd(store, id) {
    ...
    for (let i = level; i >= 0; i--) {
        ...
        const parentId = row[store.parentAttribute];
        if (parentId == null) {
...
//# sourceMappingURL=useTreeStoreHooks.js.map