    ...
    children: [
      showButtons()
        ? _jsx(DropdownMenuField, {
            ...
            value: props.path[props.path.length - 1],
            getLabel: (o) => o.label,
            getValue: (o) => o.value,
            onChange: (value) => {
              dispatch({
        ...
        : _jsx('span', {
            ...
            children: LABEL[props.path[props.path.length - 1]],
          }),
      getIn(state.filters, props.path, []).map((filter, index) => {
        return isSamePath([...props.path, index], state.activePath) &&
          ...
          ? _jsx(
              ...
              { path: props.path, index: index, filter: filter, activeSection: state.activeSection },
              index,
            )
          : _jsx(
              Entry,
