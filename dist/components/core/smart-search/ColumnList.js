...
function ColumnList(props) {
  ...
  return _jsx(Combobox, {
    ...
    options: columns.filter((c) => !stickyFilters?.includes(c.key)),
    value: attributeCode,
    getLabel: (o) => o.label,
    getValue: (o) => o.key,
    groupHeading: 'Fields',
    ...
    bottomGroup: _jsxs(_Fragment, {
      children: [
        _jsx(CommandSeparator, {}),
        _jsx(CommandGroup, {
          heading: 'Nested filters',
          children: COMBINER_OPTIONS.map((o) =>
            _jsxs(
              CommandItem,
              {
                value: o.value,
                ...
                children: [
                  ...
                  _jsx('span', { className: 'whitespace-nowrap', children: o.label }),
                  _jsx(CommandShortcut, {
                    className: 'justify-end justify-self-end whitespace-nowrap text-xs',
                    children: o.hint,
                  }),
                ],
              },
