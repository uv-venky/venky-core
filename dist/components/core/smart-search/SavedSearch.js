    ...
    children: [
      _jsx(PopoverTrigger, {
        ...
        children: _jsxs(Button, {
          ...
          children: [activeView?.name ?? 'Saved Searches', _jsx(ChevronsUpDown, { className: 'opacity-50' })],
        }),
      }),
      _jsx(PopoverContent, {
        className: 'flex max-h-[calc(var(--radix-popper-available-height)-1em)] flex-col overflow-hidden p-0',
        children: _jsx(SavedViewContent, {
