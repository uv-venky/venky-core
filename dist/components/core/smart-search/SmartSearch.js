...
function SmartSearch(props) {
  ...
  const [searchInputMode, setSearchInputMode] = useState(
  ...
  return _jsx(ErrorBoundary, {
    ...
    children: _jsx(SmartSearchColumnsProvider, {
      columns: columns,
      children: _jsx(SmartSearchProvider, {
        filters: filters,
        ...
        children: _jsxs('div', {
          ...
          children: [
            savedSearch != null
              ? _jsx('div', { className: cn(searchInputMode === 'nl' && 'hidden'), children: savedSearch })
              : null,
            _jsx(SearchInput, {
            ...
            !readOnly &&
              _jsxs(_Fragment, {
                children: [
                  showModeToggle &&
                    _jsx(SearchModeToggle, {
                      mode: searchInputMode,
                      onModeChange: handleSearchInputModeToggle,
                      disabled: isBusy,
                    }),
                  _jsx(ClearButton, { stickyFilters: stickyFilters }),
                  !hideSearchButton && _jsx(SearchButton, { isBusy: isBusy }),
                ],
              }),
          ],
        }),
