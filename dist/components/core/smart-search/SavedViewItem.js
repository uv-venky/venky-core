    ...
    CommandItem,
    {
      ...
      children: [
        ...
        _jsxs('div', {
          ...
          children: [
            view.isDefault && _jsx(Star, { className: 'ml-auto' }),
            view.id === activeView?.id && _jsx(Check, { className: 'ml-auto' }),
            (!view.isPublic || view.owner === session.userName) &&
              _jsx(Button, {
                ...
                children: busy ? _jsx(WaveDots, { active: true }) : _jsx(Trash2, { className: 'text-red-500' }),
              }),
          ],
        }),
      ],
