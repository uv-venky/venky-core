...
export function EntryEditorOptionsValueInput(props) {
  ...
  return _jsxs(Select, {
    ...
    children: [
      _jsx(SelectTrigger, {
        className: 'cursor-pointer truncate border-none focus:outline-1 focus:ring-4',
        ref: ref,
        children: _jsx(SelectValue, { placeholder: 'Choose an option', 'data-testid': 'select-value' }),
      }),
      _jsx(SelectContent, {
