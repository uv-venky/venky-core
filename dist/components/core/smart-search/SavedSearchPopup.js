    ...
    footer: _jsxs(_Fragment, {
      children: [
        _jsx(Button, {
          variant: 'outline',
          onClick: () => onClose(),
          'data-testid': 'saved-search-cancel-button',
          children: 'Cancel',
        }),
        _jsxs(Button, {
          type: 'submit',
          ...
          children: [
            isLoading && _jsx(Loader2, { className: 'h-4 w-4 animate-spin' }),
            ' ',
      ...
      children: [
        ...
        _jsxs('div', {
          ...
          children: [
            ...
            _jsx(Label, { htmlFor: defaultId, children: 'Make Default' }),
          ],
        }),
        allowsPublicViews &&
          _jsxs('div', {
            ...
            children: [
              ...
              _jsx(Label, { htmlFor: publicId, children: 'Make Public' }),
            ],
          }),
        forSmartSearch &&
          _jsxs(_Fragment, {
            children: [
              _jsxs('div', {
                ...
                children: [
                  ...
                  _jsx(Label, { htmlFor: searchFiltersId, children: 'Include Search Filters' }),
                ],
              }),
              _jsx('div', { className: 'font-semibold text-lg', children: 'Search' }),
              includeSearchFilters
                ? _jsx(SearchInput, { readOnly: true, excludeStickyFilters: true, stickyFilters: stickyFilters })
                : draftView.payload?.filters?.length
                  ? _jsx('span', {
                      className: 'text-muted-foreground text-sm',
                      children: 'Search filters are not included in this view.',
                    })
                  : _jsx('span', {
                      className: 'text-muted-foreground text-sm',
                      children: 'No search filters are available for this view.',
                    }),
            ],
          }),
      ],
