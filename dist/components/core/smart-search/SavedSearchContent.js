...
export default function SavedViewContent(props) {
  ...
  return _jsxs(_Fragment, {
    children: [
      _jsxs(Command, {
        shouldFilter: false,
        'data-testid': 'saved-search-dropdown-menu',
        children: [
          _jsx(CommandInput, {
            value: filter,
          ...
          _jsxs(CommandList, {
            children: [
              ...
              !isLoading && _jsx(CommandEmpty, { children: 'No private views found' }),
              _jsx(CommandGroup, {
                heading: 'My Views',
                children:
                  filteredPrivateViews.length === 0
                    ? _jsx(CommandItem, { disabled: true, children: 'No private views found' })
              ...
              _jsx(CommandGroup, {
                heading: 'Public Views',
                children:
                  filteredPublicViews.length === 0
                    ? _jsx(CommandItem, { disabled: true, children: 'No public views found' })
              ...
              _jsxs(CommandGroup, {
                ...
                children: [
                  _jsxs(CommandItem, {
                    ...
                    children: ['Create New View', _jsx(Plus, { className: 'ml-auto' })],
                  }),
                  _jsxs(CommandItem, {
                    value: 'update-view',
                    ...
                    children: ['Update View', _jsx(Pencil, { className: 'ml-auto' })],
                  }),
                  forSmartSearch &&
                    _jsxs(CommandItem, {
                      ...
                      children: [
                        ...
                        state.showFilters
                          ? _jsx(EyeOff, { className: 'ml-auto' })
                          : _jsx(Eye, { className: 'ml-auto' }),
                      ],
                    }),
                ],
              }),
