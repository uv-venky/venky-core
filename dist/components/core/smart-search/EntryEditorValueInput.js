  ...
  if (column && hasEditor(operator)) {
    if (column.type === 'Select') {
      ...
      if (['bn'].includes(operator)) {
        editor = _jsx(DateRangeInput, {
          className: className,
          onValueChange: (val, done) => onChange(val, done),
          ref: ref,
          value: value,
          column: column,
        });
      } else {
        editor = _jsx(DateInput, {
      ...
      if (['bn'].includes(operator)) {
        editor = _jsx(DateTimeRangeInput, {
          className: className,
          onChange: onChange,
          ref: ref,
          value: value,
      ...
      editor = _jsx(EntryEditorOptionsValueInput, {
        ...props,
