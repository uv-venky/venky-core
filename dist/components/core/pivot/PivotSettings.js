  ...
  return _jsx(Dialog, {
    ...
    children: _jsxs(DialogContent, {
      children: [
        _jsxs(DialogHeader, {
          children: [
            _jsx(DialogTitle, { children: calculatedColumn ? 'Edit Calculated Column' : 'Add Calculated Column' }),
            _jsx(DialogDescription, {
              children: 'Create a calculated column using aggregations and math operations on value columns',
            }),
          ],
        }),
        _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              className: 'space-y-2',
              children: [
                _jsx(Label, { children: 'Column Name' }),
                _jsx(Input, {
                  value: name,
            ...
            _jsxs('div', {
              className: 'space-y-2',
              children: [
                _jsx(Label, { children: 'Numerator' }),
                _jsxs('div', {
                  className: 'flex gap-2',
                  children: [
                    _jsxs(Select, {
                      value: numeratorOp,
                      onValueChange: (value) => setNumeratorOp(value),
                      children: [
                        _jsx(SelectTrigger, { className: 'w-[140px]', children: _jsx(SelectValue, {}) }),
                        _jsx(SelectContent, {
                          children: FORMULA_OPERATIONS.map((op) =>
                            _jsx(SelectItem, { value: op.value, children: op.label }, op.value),
                          ),
                        }),
                      ],
                    }),
                    _jsxs(Select, {
                      ...
                      onValueChange: (value) => setNumeratorColumn(value),
                      children: [
                        _jsx(SelectTrigger, {
                          className: 'flex-1',
                          children: _jsx(SelectValue, { placeholder: 'Select column' }),
                        }),
                        _jsx(SelectContent, {
                          children: (numeratorOp === 'sum' ||
                          numeratorOp === 'avg' ||
                          numeratorOp === 'min' ||
                          numeratorOp === 'max'
                            ? numberColumns
                            : allColumns
                          ).map((col) => _jsx(SelectItem, { value: col.key, children: col.label }, col.key)),
                        }),
                      ],
                    }),
                  ],
            ...
            _jsxs('div', {
              className: 'space-y-2',
              children: [
                _jsx(Label, { children: 'Operator' }),
                _jsxs(Select, {
                  value: mathOperator,
                  onValueChange: (value) => setMathOperator(value),
                  children: [
                    _jsx(SelectTrigger, { children: _jsx(SelectValue, {}) }),
                    _jsx(SelectContent, {
                      children: MATH_OPERATORS.map((op) =>
                        _jsx(SelectItem, { value: op.value, children: op.label }, op.value),
                      ),
                    }),
                  ],
            ...
            _jsxs('div', {
              className: 'space-y-2',
              children: [
                _jsx(Label, { children: 'Denominator' }),
                _jsxs('div', {
                  className: 'flex gap-2',
                  children: [
                    _jsxs(Select, {
                      value: denominatorOp,
                      onValueChange: (value) => setDenominatorOp(value),
                      children: [
                        _jsx(SelectTrigger, { className: 'w-[140px]', children: _jsx(SelectValue, {}) }),
                        _jsx(SelectContent, {
                          children: FORMULA_OPERATIONS.map((op) =>
                    ...
                    _jsxs(Select, {
                      ...
                      onValueChange: (value) => setDenominatorColumn(value),
                      children: [
                        _jsx(SelectTrigger, {
                          className: 'flex-1',
                          children: _jsx(SelectValue, { placeholder: 'Select column' }),
        ...
        _jsxs(DialogFooter, {
          children: [
            _jsx(Button, { variant: 'outline', onClick: () => onOpenChange(false), children: 'Cancel' }),
            _jsx(Button, {
              onClick: handleSave,
              disabled: !name || !numeratorColumn || !denominatorColumn,
              children: calculatedColumn ? 'Update' : 'Add',
            }),
          ],
        }),
      ],
    ...
    children: [
      _jsx(PopoverTrigger, {
        ...
        children: _jsx(Button, {
          variant: 'ghost',
          size: 'icon',
          children: _jsx(SettingsIcon, { className: 'h-4 w-4' }),
        }),
      }),
      _jsx(PopoverContent, {
        ...
        children: _jsxs(Card, {
          className: 'w-[350px]',
          children: [
            _jsx(CardHeader, { children: _jsx(CardTitle, { children: 'Pivot Settings' }) }),
            _jsx(CardContent, {
              className:
                'scrollbar-thin scrollbar-track-transparent scrollbar-thumb-muted-foreground/20 hover:scrollbar-thumb-muted-foreground/40 h-[calc(var(--radix-popover-content-available-height)-180px)] overflow-y-auto',
              children: _jsxs(Tabs, {
                ...
                children: [
                  _jsxs(TabsList, {
                    className: 'mb-4 grid w-full grid-cols-4',
                    children: [
                      _jsx(TabsTrigger, { value: DIMENSIONS, children: 'Rows' }),
                      _jsx(TabsTrigger, { value: PIVOTS, children: 'Columns' }),
                      _jsx(TabsTrigger, { value: METRICS, children: 'Values' }),
                      _jsx(TabsTrigger, { value: UI, children: 'UI' }),
                    ],
                  }),
                  _jsx(TabsContent, {
                    value: DIMENSIONS,
                  ...
                  _jsxs(TabsContent, {
                    value: METRICS,
                    className:
                      'scrollbar-thin scrollbar-track-transparent scrollbar-thumb-muted-foreground/20 hover:scrollbar-thumb-muted-foreground/40 flex min-h-0 flex-1 flex-col overflow-y-auto rounded-md border',
                    children: [
                      _jsx('div', {
                      ...
                      localSettings.values.length > 1 &&
                        _jsxs(_Fragment, {
                          children: [
                            _jsx(Label, { className: 'mt-4 mb-2', children: 'Values Position' }),
                            _jsxs(RadioGroup, {
                              ...
                              children: [
                                _jsxs('div', {
                                  ...
                                  children: [
                                    _jsx(RadioGroupItem, { value: 'columns', id: 'values-position-columns' }),
                                    _jsx(Label, { htmlFor: 'values-position-columns', children: 'Show as Columns' }),
                                  ],
                                }),
                                _jsxs('div', {
                                  className: 'flex items-center space-x-2',
                                  children: [
                                    _jsx(RadioGroupItem, { value: 'rows', id: 'values-position-rows' }),
                                    _jsx(Label, { htmlFor: 'values-position-rows', children: 'Show as Rows' }),
                                  ],
                                }),
                              ],
                            }),
                        ...
                        _jsxs('div', {
                          ...
                          children: [
                            ...
                            _jsxs('div', {
                              ...
                              children: [
                                _jsx(Label, { htmlFor: 'columns-before-values', children: 'Columns before Values' }),
                                _jsx('p', {
                                  className: 'text-muted-foreground text-sm',
                                  children:
                                    'For each value measure, show column dimensions (e.g. channel, year). Uncheck for column dimensions outermost with values nested.',
                                }),
                              ],
                            }),
                          ],
                      ...
                      measures.length > 0 &&
                        _jsxs(_Fragment, {
                          children: [
                            _jsx(Label, { className: 'mt-4 mb-2', children: 'Measure' }),
                            _jsxs(RadioGroup, {
                              ...
                              children: [
                                measures.map((column) =>
                                  _jsxs(
                                    'div',
                                    {
                                      className: 'flex items-center space-x-2',
                                      children: [
                                        _jsx(RadioGroupItem, { value: column.key, id: column.key }),
                                        _jsx(Label, { htmlFor: column.key, children: column.label }),
                                      ],
                                    },
                                    column.key,
                                  ),
                                ...
                                _jsxs('div', {
                                  className: 'flex items-center space-x-2',
                                  children: [
                                    _jsx(RadioGroupItem, { value: 'none', id: noneId }),
                                    _jsx(Label, { htmlFor: noneId, children: 'None' }),
                                  ],
                                }),
                              ],
                            }),
                      ...
                      _jsxs('div', {
                        ...
                        children: [
                          _jsxs('div', {
                            ...
                            children: [
                              _jsx(Label, { className: 'font-semibold', children: 'Calculated Columns' }),
                              _jsxs(Button, {
                                variant: 'outline',
                                size: 'sm',
                                onClick: () => {
                                ...
                                children: [_jsx(PlusIcon, { className: 'mr-2 h-4 w-4' }), 'Add'],
                              }),
                            ],
                          }),
                          localSettings.calculatedColumns && localSettings.calculatedColumns.length > 0
                            ? _jsx('div', {
                                className: 'space-y-2',
                                children: localSettings.calculatedColumns.map((calcCol) =>
                                  _jsxs(
                                    'div',
                                    {
                                      ...
                                      children: [
                                        _jsxs('div', {
                                          className: 'flex-1',
                                          children: [
                                            _jsx('div', { className: 'font-medium', children: calcCol.name }),
                                            calcCol.formula.type === 'aggregation' &&
                                              _jsxs('div', {
                                                className: 'text-muted-foreground text-xs',
                                                children: [
                                                  FORMULA_OPERATIONS.find(
                                                    (o) => o.value === calcCol.formula.numerator.operation,
                                                  )?.label ?? calcCol.formula.numerator.operation,
                                                  '(',
                                                  calcCol.formula.numerator.column,
                                                  ') ',
                                                  calcCol.formula.mathOperator ?? '/',
                                                  ' ',
                                                  FORMULA_OPERATIONS.find(
                                                    (o) => o.value === calcCol.formula.denominator.operation,
                                                  )?.label ?? calcCol.formula.denominator.operation,
                                                  '(',
                                                  calcCol.formula.denominator.column,
                                                  ')',
                                                  calcCol.formula.mathOperator === '%' && ' %',
                                                ],
                                              }),
                                        ...
                                        _jsxs('div', {
                                          ...
                                          children: [
                                            _jsx(Button, {
                                              ...
                                              children: _jsx(SettingsIcon, { className: 'h-3 w-3' }),
                                            }),
                                            _jsx(Button, {
                                              variant: 'ghost',
                                              size: 'icon',
                                              ...
                                              children: _jsx(TrashIcon, { className: 'h-3 w-3' }),
                                            }),
                                          ],
                                        }),
                                      ],
                            ...
                            : _jsx('p', {
                                className: 'text-muted-foreground text-sm',
                                children: 'No calculated columns added',
                              }),
                        ],
                      }),
                    ],
                  ...
                  _jsxs(TabsContent, {
                    value: UI,
                    className:
                      'scrollbar-thin scrollbar-track-transparent scrollbar-thumb-muted-foreground/20 hover:scrollbar-thumb-muted-foreground/40 flex min-h-0 flex-1 flex-col overflow-y-auto',
                    children: [
                      _jsx(Label, { className: 'mb-4 font-semibold', children: 'Density Preference' }),
                      _jsx(RadioGroup, {
                        onValueChange: (value) => {
                          setLocalSettings((prevSettings) => ({
                            ...prevSettings,
                        ...
                        children: ['default', 'roomy', 'compact', 'spacious'].map((density) =>
                          _jsxs(
                            'div',
                            {
                              className: 'flex items-center space-x-2',
                              children: [
                                _jsx(RadioGroupItem, { value: density, id: density }),
                                _jsx(Label, { htmlFor: density, children: DENSITY_PROPS[density].label }),
                              ],
                            },
                            density,
                          ),
                          ...
                          _jsxs('div', {
                            ...
                            children: [
                              ...
                              _jsxs('div', {
                                className: 'grid gap-1 leading-none',
                                children: [
                                  _jsx(Label, { htmlFor: 'show-row-totals', children: 'Show row totals' }),
                                  _jsx('p', {
                                    className: 'text-muted-foreground text-sm',
                                    children: 'Show the row totals column on the right.',
                                  }),
                                ],
                              }),
                            ],
                          ...
                          _jsxs('div', {
                            ...
                            children: [
                              ...
                              _jsxs('div', {
                                className: 'grid gap-1 leading-none',
                                children: [
                                  _jsx(Label, { htmlFor: 'show-column-totals', children: 'Show column totals' }),
                                  _jsx('p', {
                                    className: 'text-muted-foreground text-sm',
                                    children: 'Show the column totals row at the bottom.',
                                  }),
                                ],
                              }),
                            ],
                          ...
                          _jsxs('div', {
                            ...
                            children: [
                              ...
                              _jsxs('div', {
                                className: 'grid gap-1 leading-none',
                                children: [
                                  _jsx(Label, { htmlFor: 'show-grand-total', children: 'Show grand total' }),
                                  _jsx('p', {
                                    className: 'text-muted-foreground text-sm',
                                    children: 'Show the grand total cell (bottom-right corner).',
                                  }),
                                ],
                              }),
                            ],
                      ...
                      _jsxs('div', {
                        ...
                        children: [
                          ...
                          _jsxs('div', {
                            className: 'grid gap-1 leading-none',
                            children: [
                              _jsx(Label, { htmlFor: 'flatten-layout', children: 'Flatten pivot layout' }),
                              _jsx('p', {
                                className: 'text-muted-foreground text-sm',
                                children: "Repeat row labels to mimic Excel's classic PivotTable layout.",
                              }),
                            ],
                          }),
                        ],
            ...
            _jsxs(CardFooter, {
              ...
              children: [
                  ...
                  ? _jsxs(DropdownMenu, {
                      children: [
                        _jsx(DropdownMenuTrigger, {
                          asChild: true,
                          children: _jsx(Button, { variant: 'outline', children: localSettings.aggregatorName }),
                        }),
                ...
                _jsxs('div', {
                  className: 'flex gap-2',
                  children: [
                    _jsx(Button, { variant: 'outline', onClick: () => setOpen(false), children: 'Cancel' }),
                    _jsx(Button, {
                      onClick: () => {
                        setOpen(false);
                        startTransition(() => {
