...
function SimplePivotTableFooterCell({ columnIndex, data, isScrolling, rowIndex, style }) {
  ...
  if (SPANS.includes(label)) {
    ...
    label = _jsx('div', {
      className: cn(styles.wrapper, fontStyles[density], grayedOutSummaryCells && summary && styles.overlay),
    ...
    label = _jsx('div', {
      className: cn(styles.wrapper, fontStyles[density]),
      children: _jsx('div', {
        className: cn(styles.outer, grayedOutSummaryCells && summary && styles.overlay),
        children: _jsx('span', {
          className: cn(
            styles.inner,
            paddingStyles[density],
  ...
  const onClick =
    data.startColumnIndex !== 0 && onFooterCellClick && label !== ''
      ...
      : undefined;
  return _jsx(SimplePivotTableCell, {
