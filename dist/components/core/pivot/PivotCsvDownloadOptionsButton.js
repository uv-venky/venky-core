    ...
    children: [
      _jsx(DropdownMenuTrigger, {
        ...
        children: _jsx(Button, {
          variant: 'outline',
          size: 'icon',
          'data-testid': 'csv-download-options',
      ...
      _jsxs(DropdownMenuContent, {
        align: 'end',
        children: [
          _jsx(DropdownMenuItem, { onClick: exportPivotLayoutToCSV, children: 'Download Pivot Layout' }),
          _jsx(DropdownMenuItem, { onClick: exportRawRowsToCSV, children: 'Download CSV' }),
        ],
      }),
    ],
  });
