...
export declare function isHeaderEqual(
  a: ReadonlyArray<ReadonlyArray<string>>,
  b: ReadonlyArray<ReadonlyArray<string>>,
): boolean;
export declare function collapseColumn({
  columnTree,
  rowIndex,
  columnIndex,
  header,
...
export declare function collapseRow({
  rowTree,
  rowIndex,
  columnIndex,
  rowCollapseState,
...
export declare function getUpdatedCollapsedIndices<TColumnKey extends string, TItem>({
  pivot,
  oldRowCollapseState,
  oldRows,
  newRows,
