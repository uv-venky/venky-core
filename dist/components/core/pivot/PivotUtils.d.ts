...
export declare function makeKey({ rowIndex, columnIndex }: { rowIndex: number; columnIndex: number }): string;
export declare function parseKey(key: string): [number, number];
export declare const getSort: <TColumnKey extends string>(
 ...
 * calculated columns.
 */
export declare function computeAggregation<TColumnKey extends string, TItem>(
...
export declare function computeCalculatedColumn<TColumnKey extends string, TItem>(
  formula: {
    type: 'aggregation';
    numerator: {
      operation: FormulaOperation;
...
export declare const aggregators: Record<
  AggregatorNames,
...
export declare function makePivotItemData<ColumnKey extends string, Item>(
