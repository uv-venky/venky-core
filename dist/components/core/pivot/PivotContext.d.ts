...
export declare function usePivotSettingsSetterContext<TColumnKey extends string>(): React.Dispatch<
...
export declare function usePivotUpdateColumnWidthContext<TColumnKey extends string>(): (
  columnKey: TColumnKey,
  newWidth: number,
) => void;
export declare function usePivotUpdateCalculatedColumnWidthContext<_TColumnKey extends string = string>(): (
...
export declare function PivotContextProvider<TColumnKey extends string, TItem>({
  children,
  columns,
  initialSettings,
  onSettingsChange,
