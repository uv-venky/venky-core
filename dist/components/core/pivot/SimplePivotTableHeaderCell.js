  ...
  return _jsxs(SimplePivotTableCell, {
    ...
    children: [
      showExpandCollapseIcon
        ? _jsx('div', {
            className: 'shrink-0',
            children: _jsx(ExpandCollapseIcon, {
              ...
              (showExpandAllIcon || showSortIcon || showFilterIcon) &&
                _jsxs('div', {
                  ...
                  children: [
                      ...
                      _jsxs(_Fragment, {
                        children: [
                          _jsx(Button, {
                            ...
                            size: 'icon',
                            className:
                              'hidden text-table-header-foreground hover:bg-table-header-accent group-hover/cell:flex',
                            'data-testid': 'expand-all-hover',
                            children: _jsx(PlusCircleIcon, { className: 'size-4' }),
                          }),
                          _jsx(Button, {
                            ...
                            children: _jsx(MinusCircleIcon, { className: 'size-4 text-table-header-foreground' }),
                          }),
                        ],
                      }),
                    showSortIcon &&
                    ...
                    showFilterIcon &&
                      searchSource != null &&
                      _jsx(PivotSearchableMultiSelector, {
            ...
            _jsxs(_Fragment, {
              children: [
                ...
                _jsx(Button, {
                  ...
                  className: 'hover:bg-table-header-accent',
                  children: _jsx(MinusCircleIcon, { className: 'size-4' }),
                }),
                _jsx(PivotSettings, {}),
              ],
            }),
