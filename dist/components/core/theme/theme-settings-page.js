...
export default function ThemeSettingsPage() {
  ...
  return _jsx('div', {
    ...
    children: _jsxs(Tabs, {
      ...
      children: [
        _jsxs(TabsList, {
          className: 'mb-6 grid w-full shrink-0 grid-cols-2',
          children: [
            _jsxs(TabsTrigger, {
              value: 'light',
              className: 'flex items-center gap-1',
              children: [_jsx(Sun, { className: 'h-4 w-4' }), 'Light Mode'],
            }),
            _jsxs(TabsTrigger, {
              value: 'dark',
              className: 'flex items-center gap-1',
              children: [_jsx(Moon, { className: 'h-4 w-4' }), 'Dark Mode'],
            }),
          ],
        }),
        ['light', 'dark'].map((mode) =>
              ...
              children: _jsxs(Accordion, {
                ...
                children: [
                  _jsxs(AccordionItem, {
                    value: 'base',
                    children: [
                      _jsx(AccordionTrigger, { children: 'Base Colors' }),
                      _jsx(AccordionContent, {
                        children: _jsx('div', {
                          className: 'grid gap-4',
                          children: colorCategories.base.map((item) =>
                            _jsx(
                              ColorInput,
                              {
                  ...
                  _jsxs(AccordionItem, {
                    value: 'component',
                    children: [
                      _jsx(AccordionTrigger, { children: 'Component Colors' }),
                      _jsx(AccordionContent, {
                        children: _jsx('div', {
                          className: 'grid gap-4',
                          children: colorCategories.component.map((item) =>
                            _jsx(
                              ColorInput,
                              {
                                variable: item.variable,
                  ...
                  _jsxs(AccordionItem, {
                    value: 'state',
                    children: [
                      _jsx(AccordionTrigger, { children: 'State Colors' }),
                      _jsx(AccordionContent, {
                        children: _jsx('div', {
                          className: 'grid gap-4',
                          children: colorCategories.state.map((item) =>
                            _jsx(
                              ColorInput,
                              {
                                variable: item.variable,
                  ...
                  _jsxs(AccordionItem, {
                    value: 'ui',
                    children: [
                      _jsx(AccordionTrigger, { children: 'UI Element Colors' }),
                      _jsx(AccordionContent, {
                        children: _jsx('div', {
                          className: 'grid gap-4',
                          children: colorCategories.ui.map((item) =>
                            _jsx(
                              ColorInput,
                              {
                                variable: item.variable,
                  ...
                  _jsxs(AccordionItem, {
                    value: 'chart',
                    children: [
                      _jsx(AccordionTrigger, { children: 'Chart Colors' }),
                      _jsx(AccordionContent, {
                        children: _jsx('div', {
                          className: 'grid gap-4',
                          children: colorCategories.chart.map((item) =>
                            _jsx(
                              ColorInput,
                              {
                                variable: item.variable,
                  ...
                  _jsxs(AccordionItem, {
                    value: 'sidebar',
                    children: [
                      _jsx(AccordionTrigger, { children: 'Sidebar Colors' }),
                      _jsx(AccordionContent, {
                        children: _jsx('div', {
                          className: 'grid gap-4',
                          children: colorCategories.sidebar.map((item) =>
                            _jsx(
                              ColorInput,
                              {
                                variable: item.variable,
                  ...
                  _jsxs(AccordionItem, {
                    value: 'other',
                    children: [
                      _jsx(AccordionTrigger, { children: 'Other Variables' }),
                      _jsx(AccordionContent, {
                        children: _jsx('div', {
                          className: 'grid gap-4',
                          children: otherVariables.radius.map((item) =>
                            _jsx(
                              ColorInput,
                              {
                                variable: item.variable,
...
function ColorInput({ variable, name, mode, value, handleColorChange }) {
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        children: [
          _jsx(Label, { htmlFor: `${mode}-${variable}`, className: 'font-medium text-sm', children: name }),
          _jsx('div', { className: 'text-muted-foreground text-xs', children: variable }),
        ],
      }),
      _jsx('div', {
        className: 'w-40',
        children: _jsx(TailwindColorPicker, {
          value: value,
