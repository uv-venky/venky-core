...
export default function TailwindColorPicker({ value, onChange, cssVariable, label }) {
  ...
  return _jsxs('div', {
    ...
    children: [
      label && _jsx(Label, { children: label }),
      _jsxs(Popover, {
        open: open,
        ...
        children: [
          _jsx(PopoverTrigger, {
            ...
            children: _jsxs(Button, {
              ...
              children: [
                _jsx('div', { className: 'absolute top-0 bottom-0 left-0 w-12', style: { backgroundColor: value } }),
                _jsx('span', { className: 'truncate pl-12', children: value }),
                _jsx(Paintbrush, { className: 'h-4 w-4 opacity-50' }),
              ],
            }),
          }),
          _jsxs(PopoverContent, {
            ...
            children: [
              _jsxs('div', {
                ...
                children: [
                  _jsx('h4', { className: 'font-medium text-sm', children: 'Tailwind CSS v4 Colors' }),
                  _jsxs('p', {
                    className: 'mt-1 text-muted-foreground text-xs',
                    children: ['Select a color to update ', cssVariable],
                  }),
                ],
              }),
              _jsxs(Tabs, {
                ...
                children: [
                  _jsx('div', {
                    ...
                    children: _jsx(TabsList, {
                      ...
                      children: Object.keys(colorGroups).map((group) =>
                        _jsx(
                          TabsTrigger,
                          {
                            value: group,
                            className:
                              'rounded-none border-b-2 border-b-transparent data-[state=active]:border-b-primary data-[state=active]:bg-transparent',
                            children: group,
                          },
                          group,
                        ),
                              ...
                              'div',
                              {
                                ...
                                children: [
                                  ...
                                  _jsx('div', {
                                    ...
                                    children: tailwindColors[color].map((shade) =>
                                      _jsx(
                                        'button',
                                        {
                                          type: 'button',
                                          ...
                                          children:
                                            ...
                                            _jsx(Check, {
                                              className: 'h-3 w-3 text-white drop-shadow-[0_0_1px_rgba(0,0,0,0.5)]',
                                            }),
                                        },
                                        shade,
                                      ),
                  ...
                  _jsxs('div', {
                    ...
                    children: [
                      _jsxs('div', {
                        className: 'flex-1',
                        children: [
                          _jsx(Label, { htmlFor: customColorId, className: 'text-xs', children: 'Custom Color' }),
                          _jsxs('div', {
                      ...
                      _jsx('div', { className: 'h-8 w-8 rounded-md border', style: { backgroundColor: customColor } }),
                    ],
                  }),
                  _jsx('p', {
                    className: 'mt-2 text-muted-foreground text-xs',
                    children: 'Enter a hex value or CSS variable. Right-click any color to copy its variable.',
                  }),
                ],
              }),
            ],
