...
export default function AuditCharts({ stats }) {
    ...
    return _jsxs('div', {
      ...
      children: [
        ...
        _jsxs('p', {
          ...
          children: [payload[0].value, ' changes (', percentage, '%)'],
        }),
      ],
    });
  };
  ...
  const BarTooltip = ({ active, payload, label }) => {
    ...
    return _jsxs('div', {
      ...
      children: [
        ...
        _jsxs('p', {
          className: 'text-muted-foreground text-xs',
          children: [payload[0].value, ' changes (', payload[0].payload.percentage, '%)'],
        }),
      ],
    });
  };
  ...
  if (stats.total === 0) {
    return _jsx('div', {
      ...
      children: _jsx('p', { children: 'No audit data available to display charts' }),
    });
  }
  return _jsx('div', {
        ...
        _jsxs(TabsList, {
          ...
          children: [
            _jsxs(TabsTrigger, {
              value: 'changeType',
              className: 'gap-2',
              children: [_jsx(PieChartIcon, { className: 'size-4' }), 'Change Types'],
            }),
            _jsxs(TabsTrigger, {
              value: 'breakdown',
              className: 'gap-2',
              children: [_jsx(Calendar, { className: 'size-4' }), 'Breakdown'],
            }),
          ],
        }),
        _jsx(TabsContent, {
                ...
                children: _jsxs(PieChart, {
                  children: [
                    _jsx(Pie, {
                      ...
                      children: changeTypeData.map((entry) => _jsx(Cell, { fill: entry.color }, `cell-${entry.name}`)),
                    }),
                    _jsx(Tooltip, { content: _jsx(PieTooltip, {}) }),
                  ],
                }),
              }),
              _jsx(CustomLegend, { data: changeTypeData }),
            ],
          }),
        }),
        _jsx(TabsContent, {
              ...
              _jsx(ResponsiveContainer, {
                ...
                children: _jsxs(BarChart, {
                  ...
                  children: [
                    ...
                    _jsx(Tooltip, { content: _jsx(BarTooltip, {}) }),
                    _jsx(Bar, {
                      dataKey: 'value',
                      radius: [0, 6, 6, 0],
                      maxBarSize: 28,
                      animationDuration: 750,
                      children: breakdownData.map((entry) => _jsx(Cell, { fill: entry.color }, `cell-${entry.name}`)),
                    }),
                  ],
                }),
              }),
              _jsx(CustomLegend, { data: breakdownData }),
            ],
          }),
        }),
      ],
