...
export default function QueryHistory({ onSelectQuery, onHistoryUpdated }) {
  ...
  if (loading) {
    return _jsx('div', {
      className: 'p-4',
      children: _jsx('div', { className: 'text-muted-foreground text-sm', children: 'Loading history...' }),
    });
  }
  return _jsx('div', {
        ...
        children:
          history.length === 0
            ? _jsxs('div', {
                ...
                children: [
                  _jsx(Clock, { className: 'mx-auto mb-2 h-8 w-8 opacity-50' }),
                  _jsx('p', { className: 'text-sm', children: 'No saved queries' }),
                ],
              })
            : _jsx('div', {
                className: 'space-y-2',
                  ...
                  _jsxs(
                    'div',
                    {
                      ...
                      children: [
                            ...
                            _jsxs('div', {
                              ...
                              children: [
                                _jsx('div', {
                                  ...
                                  children: item.name || 'Unnamed Query',
                                }),
                                _jsx('div', {
                            ...
                            _jsxs('div', {
                              ...
                              children: [
                                _jsx(Button, {
                                  ...
                                  title: 'Run query',
                                  children: _jsx(Play, { className: 'h-3 w-3' }),
                                }),
                                _jsx(CopyToClipboard, { text: item.query }),
                                _jsx(Button, {
                                  variant: 'ghost',
                                  size: 'sm',
                        ...
                        _jsx('div', {
                          className: 'overflow-x-auto rounded bg-muted/30 p-2 font-mono text-xs',
                          children: item.query.length > 100 ? `${item.query.substring(0, 100)}...` : item.query,
                        }),
                      ],
                    },
                    item.id,
