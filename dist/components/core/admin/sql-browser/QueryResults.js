        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              ...
              _jsx('span', { className: 'font-medium', children: 'Query Error' }),
            ],
          }),
          _jsx('div', { className: 'rounded border bg-red-50 p-3 text-red-600 text-sm', children: result.error }),
        ],
      }),
    });
  }
          ...
          children: [
              ...
              children: [
                _jsxs('div', {
                  ...
                  children: [
                    ...
                    _jsx('span', { className: 'font-medium text-sm', children: 'Query executed successfully' }),
                  ],
                }),
                _jsxs('div', {
                  ...
                  children: [
                    ...
                    _jsxs('span', { className: 'text-xs', children: [result.executionTime.toFixed(2), 'ms'] }),
                  ],
                }),
                _jsxs('span', {
                  className: 'text-muted-foreground text-xs',
                  children: [result.rowCount, ' row', result.rowCount !== 1 ? 's' : ''],
                }),
              ],
            }),
            result.rows.length > 0 &&
              _jsxs(Button, {
                ...
                size: 'sm',
                onClick: exportToCSV,
                children: [_jsx(Download, { className: 'mr-2 h-4 w-4' }), 'Export CSV'],
              }),
          ],
        }),
      result.rows.length > 0
        ...
        : _jsx('div', {
            ...
            children: _jsx('div', { className: 'text-sm', children: 'No results returned' }),
          }),
    ],
  });
}
