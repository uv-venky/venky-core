  ...
  return _jsx(PageLayout, {
    ...
    icon: _jsxs('div', {
      ...
      children: [
        _jsx('div', {
          className:
            'absolute inset-0 animate-pulse rounded-xl bg-gradient-to-br from-cyan-500/20 to-teal-500/20 blur-xl',
        }),
        _jsx('div', {
          className:
            'relative flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500 to-teal-500 shadow-lg',
    ...
    toolbar: _jsxs(Button, {
      ...
      disabled: isLoading,
      className:
        'group relative overflow-hidden bg-gradient-to-r from-cyan-600 to-teal-600 font-medium text-white shadow-lg transition-all duration-300 hover:shadow-xl',
      children: [
        _jsxs('span', {
        ...
        _jsx('div', {
          className:
            'absolute inset-0 bg-gradient-to-r from-cyan-500 to-teal-500 opacity-0 transition-opacity duration-300 group-hover:opacity-100',
        }),
      ],
    }),
    mainSection: _jsxs(ResizablePanelGroup, {
      ...
      children: [
        _jsx(ResizablePanel, {
          ...
          minSize: '0%',
          maxSize: '50%',
          children: _jsx(SchemaExplorer, { onTableDoubleClick: handleTableDoubleClick, onAddTab: dispatch.addTab }),
        }),
        ...
        _jsx(ResizablePanel, {
          ...
          children: _jsxs('div', {
            ...
            children: [
              _jsx(SQLTabBar, { onFormatSQL: formatSQL }),
              _jsxs(ResizablePanelGroup, {
                ...
                children: [
                  ...
                  _jsx(ResizablePanel, {
                    ...
                    children: _jsx('div', {
                      className: 'h-full overflow-hidden',
                      children: activeTab?.result
                        ? _jsx(QueryResults, { result: activeTab.result })
                        : _jsx(EmptyState, { actionLabel: 'Run' }),
                    }),
                  }),
                ],
              }),
  ...
  if (!isAdmin) {
    return _jsx('div', {
      ...
      children: _jsxs('div', {
        ...
        children: [
          _jsx('h2', { className: 'mb-4 font-bold text-2xl text-red-600', children: 'Access Denied' }),
          _jsx('p', { className: 'text-gray-600', children: 'Access restricted to admins.' }),
        ],
      }),
    });
  }
