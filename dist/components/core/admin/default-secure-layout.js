...
} from '../../../components/sidebar/sidebar-visibility-context';
...
export default function DefaultSecureLayout({ children, session, hideSidebar = false }) {
  ...
  return _jsx(SessionProvider, {
    session: session,
    onSettingsChange: (key, value) => void updateProfileMutation(key, value),
    children: _jsxs(TeamProvider, {
      children: [
        _jsx(SSEConnectionBanner, {}),
        _jsx(VersionUpdateBanner, {}),
        _jsx(SidebarVisibilityProvider, {
          children: _jsxs(DefaultSecureLayoutContent, {
            session: session,
            hideSidebar: hideSidebar,
            children: [_jsx(DataLoadingTracker, {}), children, _jsx(Devtools, {})],
          }),
        }),
      ],
    }),
...
function DefaultSecureLayoutContent({ children, session, hideSidebar: hideSidebarProp = false }) {
  ...
  return _jsx(SidebarProvider, {
    defaultOpen: session.settings.sidebarOpen ?? true,
    children: shouldRenderSidebar
      ? _jsxs(SidebarWrapper, {
          children: [
            _jsx(AppSidebar, {}),
            _jsx(SidebarInset, {
              children: _jsx(Suspense, {
                fallback: _jsx(Suspended, { name: 'DefaultSecureLayout' }),
                children: children,
              }),
            }),
            showRightSidebar && _jsx(SidebarRight, {}),
          ],
        })
      : _jsx(Suspense, { fallback: _jsx(Suspended, { name: 'DefaultSecureLayout' }), children: children }),
  });
}
