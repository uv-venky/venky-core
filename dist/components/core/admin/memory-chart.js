  ...
  return _jsx(ChartContainer, {
    ...
    children: _jsx(ResponsiveContainer, {
      ...
      children: _jsxs(BarChart, {
        ...
        children: [
          _jsx(CartesianGrid, { strokeDasharray: '3 3', horizontal: false }),
          _jsx(XAxis, { type: 'number', tickFormatter: (value) => `${value.toFixed(1)} ${unit}` }),
          _jsx(YAxis, { type: 'category', dataKey: 'name' }),
          _jsx(Tooltip, {
            content: _jsx(ChartTooltipContent, { formatter: (value) => `${Number(value).toFixed(2)} ${unit}` }),
          }),
          _jsx(Legend, {}),
          _jsx(Bar, { dataKey: 'used', stackId: 'a', fill: 'var(--color-amber-400)', name: `Used (${unit})` }),
          _jsx(Bar, { dataKey: 'free', stackId: 'a', fill: 'var(--color-green-400)', name: `Free (${unit})` }),
        ],
      }),
    }),
  });
