...
export function DropdownMenuField({
  ...
  return _jsxs(DropdownMenuComponent, {
    open: open,
    ...
    children: [
      ...
      _jsx(DropdownMenuTrigger, {
        ...
        children: _jsx(Button, {
          ...
          'data-tip':
            iconTrigger && selected && typeof getLabel(selected) === 'string' ? getLabel(selected) : undefined,
          children: _jsxs('div', {
            className: 'flex flex-row items-center justify-between gap-2',
            children: [
              children ?? (selected ? getLabel(selected) : placeholder),
              !iconTrigger && _jsx(ChevronDown, { className: 'size-4' }),
            ],
          }),
        }),
      }),
