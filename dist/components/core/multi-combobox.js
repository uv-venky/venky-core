  ...
  return _jsxs(Popover, {
    ...
    children: [
      ...
      _jsx(PopoverContent, {
        align: 'start',
        className:
          'w-[max(var(--radix-popper-anchor-width),14rem)] max-w-[min(24rem,calc(100vw-2rem))] overflow-hidden p-0',
          ...
          children: [
            _jsxs('div', {
              ...
              children: [
                ...
                topContent ? _jsx('div', { className: 'border-b bg-popover', children: topContent }) : null,
              ],
            }),
            _jsxs(CommandList, {
                          ...
                          _jsx(
                            CommandItem,
                            {
                              ...
                              onSelect: () => {
                                ...
                                onSelect(
                                  newValues,
                                  newValues.map((v) => valueOptionMap.get(v) ?? {}),
                                );
                              },
                              ...
                              children: _jsxs('div', {
                                ...
                                children: [
                                  ...
                                  _jsx('span', { className: 'flex-1 truncate text-left', children: getLabel(option) }),
                                ],
                              }),
                            },
                            getValue(option),
