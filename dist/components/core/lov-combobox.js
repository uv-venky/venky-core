...
export default function LOVCombobox({
  open,
  onOpenChange,
  store: _store,
  onSelect,
  ...
  const triggerButton =
    trigger || _jsx(Button, { variant: 'outline', className: 'sr-only', 'aria-hidden': 'true', children: title });
  return _jsxs(Popover, {
    open: open,
    onOpenChange: handleCancel,
    modal: true,
    children: [
      _jsx(PopoverTrigger, { asChild: true, children: triggerButton }),
      open &&
        _jsx(PopoverContent, {
          ...
          children: _jsxs('div', {
            ...
            children: [
              _jsx('div', { className: 'mb-3 font-semibold text-sm', children: title }),
              _jsx(
              ...
              !singleSelection &&
                _jsxs('div', {
                  ...
                  children: [
                    _jsx(Button, { variant: 'outline', onClick: handleCancel, children: 'Cancel' }),
                    _jsxs(Button, {
                      onClick: handleConfirm,
                      disabled: selectedValues.length === 0,
                      children: ['Select (', selectedValues.length, ')'],
                    }),
                  ],
                }),
            ],
