...
export default function AvatarUploadDialog({ open, onOpenChange, onSave, initialImage }) {
  ...
  return _jsx(Dialog, {
    ...
    children: _jsxs(DialogContent, {
      className: 'flex min-w-[800px] flex-col gap-4',
      children: [
        _jsx(DialogHeader, { children: _jsx(DialogTitle, { children: 'Upload Avatar' }) }),
        !imageSrc &&
          _jsxs('div', {
            ...getRootProps(),
            className:
              'flex h-40 cursor-pointer items-center justify-center rounded-md border border-dashed p-4 text-sm',
            'data-testid': 'avatar-dropzone',
            children: [
              _jsx('input', { ...getInputProps(), 'data-testid': 'avatar-file-input' }),
        ...
        imageSrc &&
          _jsxs('div', {
            ...
            children: [
              _jsxs('div', {
                ref: containerRef,
                className: 'relative h-72 w-72 overflow-hidden rounded-md',
                children: [
                  _jsx(TransformWrapper, {
                    ref: transformRef,
                    minScale: 1,
                    centerOnInit: true,
                    maxScale: 3,
                  ...
                  _jsx('div', {
                    className:
                      'pointer-events-none absolute top-1/2 left-1/2 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-md border-2 border-primary',
                    'aria-hidden': 'true',
                  }),
                ],
              }),
              _jsx(Slider, { min: 1, max: 3, step: 0.1, value: [scale], onValueChange: handleSliderChange }),
            ],
          }),
        _jsxs(DialogFooter, {
          children: [
            ...
            imageSrc &&
              _jsxs(Button, {
                ...
                children: [isSaving && _jsx(Loader2Icon, {}), ' Save'],
              }),
          ],
        }),
      ],
