...
export declare const getComments: (
  client: PgPoolClient,
  session: Session,
  context: string,
  contextId: string,
...
export declare const reactToComment: (
  client: PgPoolClient,
  session: Session,
  commentId: string,
...
export declare const getCommentStats: (
  client: PgPoolClient,
  session: Session,
  context: string,
  contextId: string,
...
export declare const getCommentView: (
  client: PgPoolClient,
  session: Session,
  context: string,
  contextId: string,
) => Promise<string | undefined>;
export declare const setCommentView: (
  client: PgPoolClient,
  session: Session,
  context: string,
  contextId: string,
