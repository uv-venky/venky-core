...
export function Comments({
  ...
  if (loading && isInitialLoadRef.current) {
    return _jsx(Card, {
      className: cn('wv-card mx-auto w-full max-w-4xl', className),
      children: _jsxs(CardContent, {
        className: 'p-8 text-center',
        children: [
          _jsx('div', { className: 'mx-auto h-8 w-8 animate-spin rounded-full border-primary border-b-2' }),
          _jsx('p', { className: 'mt-2 text-muted-foreground', children: 'Loading comments...' }),
        ],
      }),
    });
  }
  return _jsxs(Card, {
    className: cn('wv-card mx-auto flex h-full w-full max-w-4xl flex-col overflow-hidden pb-0', className),
    children: [
      _jsx(CardHeader, {
        className: 'shrink-0 gap-0 pb-0',
        children: _jsxs('div', {
          ...
          children: [
            _jsxs(CardTitle, {
              ...
              children: [
                _jsx(MessageCircle, { className: 'h-5 w-5' }),
                title,
                _jsx(Badge, { variant: 'secondary', className: 'ml-2', children: comments.length }),
              ],
            }),
            _jsxs('div', {
      ...
      _jsxs(CardContent, {
        className: 'flex min-h-0 flex-1 flex-col border-t p-0',
        children: [
          _jsx(AutoSizerContainer, {
            ...
            children:
              comments.length === 0
                ? _jsx('div', {
                    ...
                    children: _jsxs('div', {
                      children: [
                        _jsx(MessageCircle, { className: 'mx-auto mb-4 h-12 w-12 opacity-50' }),
                        _jsx('p', { children: 'No comments yet. Start the discussion!' }),
                      ],
                    }),
                  })
                : _jsxs(_Fragment, {
                    children: [
                      loading &&
                        ...
                        _jsxs('div', {
                          className:
                            'absolute top-0 z-10 flex w-full items-center justify-center bg-background/80 py-4 backdrop-blur-sm',
                          children: [
                            _jsx('div', { className: 'h-6 w-6 animate-spin rounded-full border-primary border-b-2' }),
                            _jsx('span', {
                              className: 'ml-2 text-muted-foreground text-sm',
                              children: 'Loading older comments...',
                            }),
                          ],
                        }),
                      containerHeight > 0 &&
                        _jsx(
                          List,
                          {
                            ...
                            rowComponent: ({ index, style, ...props }) => {
                                  ...
                                  children: [
                                    ...
                                    _jsx('div', {
                                      ...
                                      children: _jsxs(Badge, {
                                        variant: 'outline',
                                        className: 'border-blue-200 bg-background px-3 text-blue-600',
                                        children: [
                                          newComments.length,
                                          ' new message',
                              ...
                              const isNew =
                                parseISO(item.comment.createdAt) >
                                (lastViewedAt ? parseISO(lastViewedAt) : new Date(0));
                              return _jsx('div', {
                          ...
                          `${context}-${contextId}-${isInitialLoadRef.current}`,
                        ),
                    ],
                  }),
          }),
