  ...
  return _jsxs('div', {
    ...
    children: [
      replyingTo &&
        _jsx('div', {
          className: 'mb-3',
          children: _jsx(ReplyPreview, { comment: replyingTo, currentUser: currentUser, onCancelReply: onCancelReply }),
        }),
      _jsxs('div', {
        className: 'flex gap-3',
        children: [
          _jsx(UserAvatar, { userName: currentUser, showDisplayName: false, showEmail: false }),
          _jsxs('div', {
            className: 'flex-1',
            children: [
                      ...
                      'div',
                      {
                        ...
                        children: [
                          ...
                          _jsxs('div', {
                            ...
                            children: [
                              _jsx('p', { className: 'truncate font-medium text-sm', children: file.name }),
                              _jsx('p', {
              ...
              _jsx('div', { className: 'mt-2 text-muted-foreground text-xs', children: 'Press Cmd+Enter to send' }),
            ],
          }),
        ],
      }),
