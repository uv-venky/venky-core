...
export default function HeaderCell({
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('span', { className: 'truncate', children: title }),
      _jsxs('div', {
        ...
        children: [
          isApplied &&
            ...
            _jsx(Button, {
              ...
              children: _jsx(FunnelX, {}),
            }),
          sortable &&
            column.getCanSort() &&
            (!column?.getIsResizing() || sortState != null || isSorting) &&
            _jsx(SortMenu, {
              ...
              sortIcon: isSorting ? _jsx(Loader2, { className: 'size-4 animate-spin' }) : sortIcon,
              store: store,
              open: sortMenuOpen,
