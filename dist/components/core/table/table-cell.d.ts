...
export declare function DirtyCellIndicator<T extends object>(
  props: DirtyCellIndicatorProps<T>,
): import('react/jsx-runtime').JSX.Element;
export declare function Cell<T extends object>({
  className,
  children,
  dataTip,
  dataTipHtml,
...
export declare function TableRowSelectionCell({
  className,
  row,
  isDisabled,
}: {
