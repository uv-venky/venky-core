  ...
  return _jsxs(DropdownMenu, {
    ...
    children: [
      _jsx(DropdownMenuTrigger, {
        asChild: true,
        children: isSorting
          ? _jsx(Loader2, { className: 'mx-2 size-4 animate-spin' })
          : _jsx(SortIcon, {
        ...
        _jsxs(DropdownMenuContent, {
          children: [
            _jsxs(DropdownMenuItem, {
              ...
              children: [_jsx(ArrowUpIcon, { className: iconClassName }), ' Order Ascending'],
            }),
            _jsxs(DropdownMenuItem, {
              className: 'cursor-pointer',
              ...
              children: [_jsx(ArrowDownIcon, { className: iconClassName }), ' Order Descending'],
            }),
            _jsxs(DropdownMenuItem, {
              className: 'cursor-pointer',
            ...
            !disableHeaderFilters &&
              _jsxs(DropdownMenuItem, {
                ...
                children: [
                  headerFiltersHidden ? _jsx(FunnelPlus, {}) : _jsx(FunnelX, {}),
                  ' ',
                  headerFiltersHidden ? 'Show' : 'Hide',
                  ' Filters',
                ],
              }),
          ],
  ...
  if (sortDirection != null) {
    ...
    icon =
      sortDirection === 'ascending'
        ? _jsx(ArrowUpIcon, { className: iconClassName })
        : _jsx(ArrowDownIcon, { className: iconClassName });
  }
