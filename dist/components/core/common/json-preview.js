...
function JsonStringValue({ value, maxStringPreviewLength, theme }) {
  ...
  if (showFull) {
    return _jsxs('span', {
      ...
      children: [
        _jsxs('span', {
          className: theme === 'dark' ? 'text-emerald-300' : 'text-emerald-700',
          children: ['"', value, '"'],
        }),
        isLong &&
          _jsxs('button', {
            ...
            children: [_jsx(ChevronUp, { className: 'size-3 shrink-0' }), 'Show less'],
          }),
      ],
    });
  }
  return _jsxs('span', {
    ...
    children: [
      _jsxs('span', {
        className: theme === 'dark' ? 'text-emerald-300' : 'text-emerald-700',
        children: ['"', value.slice(0, maxStringPreviewLength), '..."'],
      }),
      _jsxs('button', {
        type: 'button',
        ...
        children: [_jsx(ChevronDown, { className: 'size-3 shrink-0' }), 'Show more (', value.length, ')'],
      }),
    ],
  });
}
function JsonArrayTreeBranch({
  ...
  return _jsxs('div', {
    ...
    children: [
        ...
        children: [
          _jsxs('button', {
            ...
            children: [
              ...
              _jsxs('span', {
                className: theme === 'dark' ? 'text-violet-300' : 'text-violet-700',
                children: ['[', value.length, ']'],
              }),
            ],
          }),
          ctx &&
            expandableDescendantPaths.length > 0 &&
            _jsxs('span', {
              className: cx('text-[11px]', theme === 'dark' ? 'text-zinc-500' : 'text-zinc-500'),
              children: [
                _jsx('button', {
                  type: 'button',
                ...
                _jsx('span', { className: 'mx-0.5', children: '\u00B7' }),
                _jsx('button', {
                  type: 'button',
      ...
      expanded &&
        _jsxs('div', {
          className: cx('ml-2 border-l pl-2', theme === 'dark' ? 'border-zinc-700' : 'border-zinc-300'),
          children: [
            visible.map((item, index) => {
              ...
              return _jsxs(
                'div',
                {
                  ...
                  children: [
                    _jsxs('span', { className: 'text-zinc-500', children: [index, ':'] }),
                    _jsx(JsonTreeValue, {
                      value: item,
                      path: childPath,
                      depth: depth + 1,
            ...
            arrayHiddenCount > 0 &&
              _jsxs('button', {
                ...
                children: ['... ', arrayHiddenCount, ' more items'],
              }),
          ],
        }),
    ],
          ...
          children: [
            ...
            objectHiddenCount > 0 &&
              _jsxs('button', {
                ...
                children: ['... ', objectHiddenCount, ' more keys'],
              }),
          ],
        }),
    ],
...
export function JsonTreeValue({
  ...
  if (Array.isArray(value)) {
    ...
    return _jsx(JsonArrayTreeBranch, {
      value: value,
      theme: theme,
      depth: depth,
      defaultExpandedDepth: defaultExpandedDepth,
  ...
  if (isPlainObject(value)) {
    ...
    return _jsx(JsonObjectTreeBranch, {
      entries: entries,
      theme: theme,
      depth: depth,
      defaultExpandedDepth: defaultExpandedDepth,
      ...
      ? _jsxs(Tabs, {
          ...
          children: [
              ...
              children: _jsxs(TabsList, {
                ...
                children: [
                  _jsx(TabsTrigger, {
                    ...
                    className: JSON_PREVIEW_TOGGLE_TRIGGER_CLASS,
                    children: 'Tree',
                  }),
                  _jsx(TabsTrigger, {
            ...
            _jsx(TabsContent, {
              value: VIEW_MODES.Tree,
              className:
                'scrollbar-thin scrollbar-track-transparent scrollbar-thumb-muted-foreground/20 hover:scrollbar-thumb-muted-foreground/40 mt-0 min-h-0 flex-1 overflow-auto font-mono text-[12px] leading-5',
              children: _jsx(JsonTreeContext.Provider, {
                value: treeContext,
