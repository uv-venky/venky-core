...
export function VersionUpdateBanner() {
  ...
  return _jsx('div', {
    ...
    children: _jsxs(Alert, {
      variant: 'warning',
      className:
        'flex max-w-2xl items-center gap-3 rounded-t-none border-yellow-500/50 border-t-0 bg-yellow-50 dark:bg-yellow-950/20',
      children: [
        _jsx(RefreshCw, { className: 'size-4 shrink-0 text-yellow-600 dark:text-yellow-400' }),
        _jsx(AlertDescription, {
          className: 'flex-1 text-yellow-900 dark:text-yellow-100',
          children: 'A new version is available. Please save your work and refresh the page.',
        }),
        _jsxs(Button, {
          onClick: handleRefresh,
          size: 'sm',
          variant: 'outline',
          children: [_jsx(RefreshCw, { className: 'mr-2 size-4' }), 'Refresh'],
        }),
      ],
    }),
  });
