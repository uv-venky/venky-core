...
export default function UserAvatar({ userId, userName, showDisplayName = true, showEmail = true, showImage = true }) {
  ...
  if (loading || 'isLoading' in userAvatar) {
    return _jsx(Avatar, {
      ...
      children: _jsx(AvatarFallback, { children: _jsx(WaveDots, { active: true }) }),
    });
  }
  const bgcolor = getColor(userAvatar.email);
  return _jsx(UserProfilePopover, {
    user: userAvatar,
    children: _jsxs('div', {
      ...
      children: [
        showImage &&
          _jsx(PopoverAnchor, {
            children: _jsxs(Avatar, {
              className: 'size-5',
              children: [
                _jsx(AvatarImage, { src: userAvatar.picture ?? undefined }),
                _jsx(AvatarFallback, {
                  className: 'text-[9px]',
                  style: {
                  ...
                  children: getAvatarChars(userAvatar.email),
                }),
              ],
            }),
          }),
        (showDisplayName || showEmail) &&
          _jsxs('div', {
            ...
            children: [
              showDisplayName && _jsx('span', { className: 'font-medium text-sm', children: userAvatar.displayName }),
              showEmail && _jsx('span', { className: 'text-muted-foreground text-xs', children: userAvatar.email }),
            ],
          }),
      ],
    }),
