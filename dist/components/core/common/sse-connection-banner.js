...
export function SSEConnectionBanner() {
  ...
  return _jsx('div', {
    ...
    children: _jsxs(Alert, {
      variant: 'warning',
      className:
        'flex max-w-2xl items-center gap-3 rounded-t-none border-yellow-500/50 border-t-0 bg-yellow-400 dark:bg-yellow-950/20',
      children: [
        _jsx(WifiOff, { className: 'size-4 shrink-0 text-yellow-600 dark:text-yellow-400' }),
