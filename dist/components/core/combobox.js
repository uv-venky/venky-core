            ...
            _jsx('div', {
              ...
              children:
                value && selectedOption && renderOption
                  ? _jsx('span', { className: 'min-w-0 flex-1 truncate', children: renderOption(selectedOption) })
                  : value && selectedOption
                    ? _jsxs(_Fragment, {
                        children: [
                          getIcon?.(selectedOption),
                          _jsx('span', { className: 'truncate', children: getLabel(selectedOption) }),
                        ],
                      })
                    : _jsx('span', {
      ...
      _jsx(PopoverContent, {
        ...
        children: _jsxs(Command, {
          ...
          children: [
            ...
            _jsxs(CommandList, {
              className: 'max-h-[calc(var(--radix-popper-available-height)-56px)] overflow-y-auto',
              children: [
                isLoading &&
                  _jsx(CommandLoading, {
                    children: _jsxs('div', {
                      className: 'flex flex-row items-center gap-2',
                      children: [_jsx(Loader2, { className: 'size-4 animate-spin' }), ' loading...'],
                    }),
                  }),
                !isLoading && _jsx(CommandEmpty, { children: emptyText }),
                _jsx(CommandGroup, {
                  heading: groupHeading,
                  onClick: (e) => e.stopPropagation(),
                  children:
                    filteredOptions.length === 0
                      ? _jsx(CommandItem, { disabled: true, children: emptyText })
                          ...
                          _jsxs(
                            CommandItem,
                            {
                              ...
                              'data-testid': dataTestId
                                ? `${dataTestId}-item-${getValue(option)}`
                                : `combobox-item-${getValue(option)}`,
                              onSelect: () => {
                                onSelect(
                              ...
                              children: [
                                renderOption
                                  ? renderOption(option)
                                  : _jsxs(_Fragment, { children: [getIcon?.(option), getLabel(option)] }),
                                _jsx(Check, {
                                  className: cn(
                                    'ml-auto',
                                    value && value === getValue(option) ? 'opacity-100' : 'opacity-0',
                                  ),
                                }),
                              ],
                            },
