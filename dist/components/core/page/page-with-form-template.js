...
export default function PageWithFormTemplate({
  store,
  filterStartContent,
  filterEndContent,
  ...
  return _jsx(PageLayout, {
      ...
      _jsxs('div', {
        ...
        children: [
          ...
          _jsxs(Button, {
            ...
            children: [_jsx(SaveAll, { className: 'h-4 w-4' }), isSaving ? 'Saving...' : 'Save changes'],
          }),
          _jsxs(Button, {
            type: 'button',
            variant: 'destructive',
            ...
            children: [_jsx(Trash, { className: 'h-4 w-4' }), 'Delete record'],
          }),
          headerEndContent,
        ],
      }),
    filterSection: _jsxs('div', {
      ...
      children: [
        ...
        !hideColumnsMenu && _jsx(ColumnViewsDialog, { table: table, variant: 'ghost' }),
        filterEndContent,
      ],
    }),
    mainSection: _jsxs(ResizablePanelGroup, {
      ...
      children: [
        ...
        _jsx(ResizablePanel, {
          defaultSize: `${editFormProportion}%`,
          minSize: '40%',
          className: 'overflow-hidden',
          children: editForm && _jsx(EditRecordForm, { title: title, store: store, children: editForm }),
        }),
      ],
    }),
  });
