  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('p', {
        ...
        children: 'Adjust row height and how many rows load per page.',
      }),
      _jsxs('div', {
        className: 'space-y-3',
        children: [
          _jsx('h4', { className: 'font-medium text-sm', children: 'Row height' }),
          _jsx(RadioGroup, {
            value: value,
            onValueChange: (v) => onChange(v),
            className: 'gap-3',
            children: TABLE_VARIANTS.map((variant) =>
              _jsxs(
                'div',
                {
                  ...
                  children: [
                    ...
                    _jsx(Label, {
                      htmlFor: `density-${variant}`,
                      className: 'cursor-pointer font-normal',
                      children: DENSITY_PROPS[variant].label,
                    }),
                  ],
                },
                variant,
      ...
      _jsxs('div', {
        className: 'space-y-3',
        children: [
          _jsx('h4', { className: 'font-medium text-sm', children: 'Rows per page' }),
          _jsx('div', {
            ...
            children: _jsxs(Select, {
              ...
              children: [
                _jsx(SelectTrigger, {
                  ...
                  children: pageSizeDisabled
                    ? _jsx(Loader2, { className: 'size-4 animate-spin', 'aria-hidden': 'true' })
                    : _jsx(SelectValue, { placeholder: pageSize }),
                }),
                _jsx(SelectContent, {
                  side: 'top',
                  children: pageSizeOptions.map((option) =>
                    _jsx(
                      ...
                      {
                        value: `${option}`,
                        'data-testid': `column-views-page-size-option-${option}`,
                        children: option,
                      },
                      option,
                    ),
