    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          ...
          !hideColumnsMenu &&
            _jsx(ColumnViewsDialog, { table: table, variant: 'ghost', defaultPreferences: { tableVariant: variant } }),
          headerEndContent,
        ],
      }),
      _jsx(Suspense, {
        ...
        children: _jsxs('div', {
          ...
          children: [
            ...
            !hidePagination &&
              _jsxs('div', {
                className: 'flex shrink-0 items-center justify-end space-x-2 p-2',
                children: [
                  isStoreBusy
