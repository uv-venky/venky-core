...
export declare function createDraftFromTable<T extends object>(
  table: Table<T>,
  preferences: TableColumnPreferences,
): ColumnViewsDraft;
...
export declare function hasPersistedTableCustomization<T extends object>(
  table: Table<T>,
  snapshot: ColumnViewsSnapshot,
  defaultPreferences?: Partial<TableColumnPreferences>,
): boolean;
export declare function useColumnViewsDraft<T extends object>({
  table,
  preferences,
  onPreferencesChange,
  defaultPreferences,
