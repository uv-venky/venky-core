      ...
      children: [
        resizable &&
          _jsx('div', {
            ...
            children: _jsx(GripVertical, { className: 'size-3.5 text-muted-foreground/40' }),
          }),
        _jsxs(SheetHeader, {
          children: [
            _jsx(SheetTitle, { 'data-testid': 'edit-sheet-title', children: title }),
            description && _jsx(SheetDescription, { 'data-testid': 'edit-sheet-description', children: description }),
          ],
        }),
        _jsx('div', {
          className: cn(
        ...
        _jsxs(SheetFooter, {
          className: 'flex flex-row items-center justify-between gap-2 border-t pt-4',
          children: [
            footerContent
              ? _jsx('div', { className: 'flex-1', children: footerContent })
            ...
            _jsxs('div', {
              ...
              children: [
                _jsxs(Button, {
                  variant: 'outline',
                  'data-testid': 'edit-sheet-cancel',
                  onClick: handleClose,
                  children: [_jsx(CircleX, { className: 'h-3.5 w-3.5' }), 'Cancel'],
                }),
                allowDelete &&
                  _jsxs(Button, {
                    type: 'button',
                    ...
                    children: [_jsx(Trash, { className: 'h-4 w-4' }), 'Delete'],
                  }),
                keepOpen &&
                  _jsxs(Button, {
                    type: 'button',
                    ...
                    children: [
                      isSaving
                        ...
                        : _jsx(Save, { className: 'h-3.5 w-3.5' }),
                      'Save',
                    ],
                  }),
                _jsxs(Button, {
