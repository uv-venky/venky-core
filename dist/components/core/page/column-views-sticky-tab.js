  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('p', {
        ...
        children: 'Select which columns stay frozen on your table.',
      }),
      _jsxs('div', {
        className: 'space-y-3',
        children: [
          _jsx('h4', { className: 'font-medium text-sm', children: 'First columns' }),
          _jsx(RadioGroup, {
            value: String(stickyLeftCount),
            onValueChange: (v) => onStickyLeftChange(Number(v)),
            className: 'gap-3',
            children: STICKY_LEFT_OPTIONS.map((option) =>
              _jsxs(
                'div',
                {
                  ...
                  children: [
                    ...
                    _jsx(Label, {
                      htmlFor: `sticky-left-${option.value}`,
      ...
      _jsxs('div', {
        className: 'space-y-3',
        children: [
          _jsx('h4', { className: 'font-medium text-sm', children: 'Last columns' }),
          _jsx(RadioGroup, {
            value: String(stickyRightCount),
            onValueChange: (v) => onStickyRightChange(Number(v)),
            className: 'gap-3',
            children: STICKY_RIGHT_OPTIONS.map((option) =>
              _jsxs(
                'div',
                {
                  className: 'flex items-center gap-2',
                  children: [
                    ...
                    _jsx(Label, {
                      htmlFor: `sticky-right-${option.value}`,
                      className: 'cursor-pointer font-normal',
                      children: option.label,
                    }),
                  ],
