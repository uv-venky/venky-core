  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('button', {
        ...
        children: _jsx(GripVertical, { className: 'size-4' }),
      }),
      _jsx('span', { className: 'min-w-0 flex-1 truncate', children: label }),
      _jsx('button', {
        type: 'button',
        className:
...
export function ColumnViewsColumnsTab({ columnOptions, displayedColumnIds, onDisplayedChange, onRestore }) {
  ...
  return _jsxs('div', {
    className: 'flex min-h-0 flex-1 flex-col gap-3 px-1 py-2',
    children: [
      _jsx('p', { className: 'text-muted-foreground text-sm', children: 'Edit the column settings on your table.' }),
      _jsxs('div', {
        className: 'relative',
        children: [
          _jsx(Search, { className: 'absolute top-1/2 left-2.5 size-4 -translate-y-1/2 text-muted-foreground' }),
          _jsx(Input, {
            value: search,
          ...
          _jsxs('div', {
            ...
            children: [
              _jsxs('div', {
                ...
                children: [
                  _jsx('span', { className: 'font-medium text-sm', children: 'Displayed columns' }),
                  _jsx(Button, {
                    variant: 'link',
                    size: 'sm',
              ...
              _jsx('div', {
                className:
                  'scrollbar-thin scrollbar-track-transparent scrollbar-thumb-muted-foreground/20 hover:scrollbar-thumb-muted-foreground/40 min-h-0 flex-1 overflow-y-auto p-2',
          ...
          _jsxs('div', {
            ...
            children: [
              _jsxs('div', {
                className: 'flex items-center justify-between border-b px-3 py-2',
                children: [
                  _jsx('span', { className: 'font-medium text-sm', children: 'Available columns' }),
                  _jsx(Button, {
                    variant: 'link',
                    size: 'sm',
                    className: 'h-auto p-0 text-xs',
                    ...
                    : availableColumns.map((option) =>
                        _jsxs(
                          'div',
                          {
                            ...
                            children: [
                              _jsx('span', { className: 'min-w-0 flex-1 truncate', children: option.label }),
                              _jsx('button', {
                                type: 'button',
                                ...
                                children: _jsx(Plus, { className: 'size-4' }),
                              }),
                            ],
                          },
                          option.value,
