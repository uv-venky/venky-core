...
export declare function getDefaultColumnVisibility<T extends object>(
  tableColumns: AccessorKeyColumnDef<T>[],
 ...
 */
export declare function mergeSavedColumnOrder<T extends object>(
  savedOrder: string[],
  tableColumns: AccessorKeyColumnDef<T>[],
): string[];
export declare function getDefaultColumnOrder<T extends object>(
  tableColumns: AccessorKeyColumnDef<T>[],
  defaultVisibleColumnOrder: Extract<keyof T, string>[] | undefined,
): string[];
