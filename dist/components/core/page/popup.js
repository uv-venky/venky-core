  ...
  return _jsx(Dialog, {
    ...
    children: _jsxs(DialogContent, {
      ...
      children: [
            ...
            children: [
              _jsxs('div', {
                ...
                children: [
                  ...
                  description && _jsx(DialogDescription, { 'data-testid': 'popup-description', children: description }),
                ],
              }),
              headerToolbar && _jsx('div', { className: 'flex shrink-0 items-center gap-2', children: headerToolbar }),
            ],
          }),
        }),
        _jsx('div', {
        ...
        footer &&
          _jsx(DialogFooter, { className: 'shrink-0 bg-accent p-4', 'data-testid': 'popup-footer', children: footer }),
        resizable &&
          _jsx('div', {
            role: 'button',
            ...
            children: _jsx('svg', {
              ...
              children: _jsx('path', { d: 'M11 3L3 11M11 7L7 11M11 10L10 11' }),
            }),
          }),
        process.env.NODE_ENV === 'development' &&
          isResizing &&
          _jsxs('div', {
            className: 'absolute top-0 right-8 z-50 bg-background p-2',
