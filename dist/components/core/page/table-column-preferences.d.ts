...
export declare function createTableColumnPreferences(
  overrides?: Partial<TableColumnPreferences>,
 ...
 */
export declare function resolveEffectiveStickyColumns<T extends object>({
  visibleColumnIds,
  tableColumns,
  preferences,
}: {
...
export declare function isColumnStickyLeft(
  columnId: string,
  sticky: {
    left: string[];
    right: string[];
...
export declare function isColumnStickyRight(
  columnId: string,
  sticky: {
    left: string[];
    right: string[];
...
export declare function resolveSavedViewPageSize<T extends object>(
  table: Table<T>,
...
export declare function applySavedTablePreferences<T extends object>(
  table: Table<T>,
  custom?: SavedTableColumnCustom,
): void;
...
export declare function setTablePreferences<T extends object>(
  table: Table<T>,
