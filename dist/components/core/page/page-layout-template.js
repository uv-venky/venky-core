...
export default function PageLayoutTemplate({
  ...
  return _jsx(PageLayout, {
          ...
          _jsxs('div', {
            ...
            children: [
              _jsxs(Button, {
                ...
                children: [_jsx(PlusIcon, { className: 'h-4 w-4' }), addNewButtonText],
              }),
    ...
    filterSection: _jsxs('div', {
      className: 'flex flex-1 shrink-0 items-start gap-2',
      children: [
        filterStartContent,
        !hideFilters &&
          _jsx(Suspense, {
...
function MainSection({
  ...
  return _jsx(Suspense, {
    fallback: _jsx(Suspended, { name: 'MainSection' }),
    children: _jsxs('div', {
      ...
      children: [
        ...
        !hidePagination && _jsx(PaginationSection, { table: table, store: store }),
      ],
    }),
  });
}
export function PaginationSection({ table, store, hideRowsPerPageSelector = false }) {
  ...
  return _jsx(Suspense, {
    fallback: _jsx(Suspended, { name: 'PaginationSection' }),
    children: _jsxs('div', {
      className: 'flex shrink-0 select-none items-center justify-end space-x-2 p-2',
      children: [
        isStoreBusy
          ? _jsx('div', { className: 'flex-1', children: _jsx(Loader2, { className: 'size-4 animate-spin' }) })
          : rowCount != null &&
            _jsxs('div', { className: 'flex-1 text-muted-foreground text-sm', children: [rowCount, ' row(s)'] }),
        _jsx('div', {
          className: 'space-x-2',
          children: _jsx(DataTablePagination, {
            table: table,
            store: store,
            hideRowsPerPageSelector: hideRowsPerPageSelector,
          }),
        }),
      ],
    }),
