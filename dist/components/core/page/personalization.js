...
export function Personalization({ variant, className, pageId, itemId, tabs, store }) {
  ...
  const { savedSearches, createSavedSearch, updateSavedSearch, deleteSavedSearch, isLoading } = useSavedViews(
    pageId,
    itemId,
    onSelectView,
    store,
    ...
    children: [
      _jsx(DropdownMenuTrigger, {
        ...
        children: _jsxs(Button, {
          ...
          children: [
            _jsx(Settings2, { className: 'h-4 w-4' }),
            _jsx('span', { className: 'sr-only', children: 'Personalization settings' }),
          ],
        }),
      }),
      _jsx(DropdownMenuContent, {
        align: 'end',
        className:
          'flex max-h-[calc(var(--radix-popper-available-height)-1rem)] w-80 flex-col overflow-hidden rounded-lg border border-border/50 p-0 shadow-lg dark:shadow-dark',
        children: _jsxs(Tabs, {
          value: activeTab,
          onValueChange: setActiveTab,
          className: 'w-full flex-1 gap-0 overflow-hidden',
          children: [
            _jsxs(TabsList, {
              className: 'flex w-full items-center rounded-none',
              children: [
                _jsx(TabsTrigger, {
                  value: 'views',
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsx('h3', {
                      ...
                      children: 'Personalization Views',
                    }),
                    _jsx('p', {
                      className: 'mt-0.5 text-muted-foreground text-xs',
                      children: 'Manage your saved configurations',
                    }),
                  ],
                }),
                _jsx(DropdownMenuSeparator, { className: 'my-1 shrink-0' }),
                _jsx(SavedViewContent, {
...
export function useTableColumnsPersonalizationTab(table) {
  return useMemo(() => {
    const tab = {
      key: 'columns',
      label: 'Columns',
      tabContent: _jsxs(_Fragment, {
        children: [
          _jsxs('div', {
            className: 'shrink-0 px-3 py-1.5',
            children: [
              _jsx('h3', { className: 'font-medium text-foreground/90 text-sm', children: 'Toggle Columns' }),
              _jsx('p', {
                className: 'mt-0.5 text-muted-foreground text-xs',
          ...
          _jsx(DropdownMenuSeparator, { className: 'my-1' }),
          _jsx('div', {
      ...
      tabContent: _jsxs(_Fragment, {
        children: [
          _jsxs('div', {
            className: 'shrink-0 px-3 py-1.5',
            children: [
              _jsx('h3', { className: 'font-medium text-foreground/90 text-sm', children: 'Density' }),
              _jsx('p', {
                className: 'mt-0.5 text-muted-foreground text-xs',
                children: 'Adjust row height and rows per page',
              }),
            ],
          }),
          _jsx(DropdownMenuSeparator, { className: 'my-1' }),
      ...
      tabContent: _jsxs(_Fragment, {
        children: [
          _jsxs('div', {
            className: 'shrink-0 px-3 py-1.5',
            children: [
              _jsx('h3', { className: 'font-medium text-foreground/90 text-sm', children: 'Sticky columns' }),
              _jsx('p', {
                className: 'mt-0.5 text-muted-foreground text-xs',
                children: 'Freeze columns while scrolling',
              }),
            ],
          }),
          _jsx(DropdownMenuSeparator, { className: 'my-1' }),
