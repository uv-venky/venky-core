...
function PivotSavedSearchComponent({ settings, pageId, itemId, store, disableSavedSearches }) {
  ...
  const { isLoading, savedSearches, createSavedSearch, updateSavedSearch, deleteSavedSearch } = useSavedViews(
    pageId,
    itemId,
    undefined,
    store,
  );
  return _jsx(SavedSearchComponent, {
    isLoading: isLoading,
...
export function PivotFilters({
  ...
  const savedSearch = useMemo(() => {
    return disableSavedSearches
      ? undefined
      : _jsx(PivotSavedSearchComponent, {
          settings: settings,
          pageId: pageId,
          itemId: itemId,
          store: store,
...
export default function TableFilters({
  ...
  const savedSearch = useMemo(() => {
    return disableSavedSearches
      ? undefined
      : _jsx(TableSavedSearchComponent, {
          table: table,
          pageId: pageId,
          itemId: itemId,
          store: store,
