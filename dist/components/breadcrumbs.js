                      ...
                      ? _jsxs(DropdownMenu, {
                          ...
                          children: [
                            _jsx(DropdownMenuTrigger, {
                              ...
                              children: _jsx(BreadcrumbEllipsis, { className: 'h-4 w-4' }),
                            }),
                            _jsx(DropdownMenuContent, {
                              align: 'start',
                              children: breadcrumbs.slice(1, -ITEMS_TO_DISPLAY + 1).map(({ href, title }) =>
                                _jsx(
                                  DropdownMenuItem,
                                  {
                                    onClick: () => {
                            ...
                            _jsxs(DrawerContent, {
                              children: [
                                _jsxs(DrawerHeader, {
                                  className: 'text-left',
                                  children: [
                                    _jsx(DrawerTitle, { children: 'Navigate to' }),
                                    _jsx(DrawerDescription, { children: 'Select a page to navigate to.' }),
                                  ],
                                }),
                                _jsx('div', {
                                  className: 'grid gap-1 px-4',
                                  children: breadcrumbs.slice(1, -ITEMS_TO_DISPLAY + 1).map((item) =>
                                    _jsx(
                                      'button',
                                      {
                                        type: 'button',
                  ...
                  _jsx(BreadcrumbItem, {
                    children:
                      href && href !== '#' && lastItems.length !== index + 1
                        ? _jsx(BreadcrumbLink, {
                            className:
                              'max-w-20 cursor-pointer truncate text-sidebar-foreground/50 hover:text-sidebar-foreground md:max-w-none',
                            onClick: () => {
                        ...
                        : _jsx(BreadcrumbPage, {
                            className: 'max-w-20 truncate text-sidebar-foreground md:max-w-none',
                            children: title,
                          }),
                  }),
                  index < lastItems.length - 1 && _jsx(BreadcrumbSeparator, {}),
                ],
              },
              href,
            ),
