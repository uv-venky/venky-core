...
export function MultiStepForm({
  ...
  return _jsxs('div', {
    ...
    children: [
      showStepIndicator &&
        _jsx('div', {
          className: 'relative mb-8 h-1 overflow-hidden rounded-full bg-neutral-200 dark:bg-neutral-800',
          children: _jsx('div', {
            className:
              'absolute h-full rounded-full bg-linear-to-r from-black to-neutral-800 transition-all duration-300 ease-out',
            style: {
      ...
      showStepIndicator &&
        _jsx('div', {
          className:
            'flex overflow-hidden rounded-xl border border-neutral-200 bg-background shadow-lg dark:border-neutral-800 dark:bg-black',
                  ...
                  children: [
                    _jsx('div', {
                      ...
                      children: isCompleted
                        ...
                        : _jsx('span', { className: 'font-semibold text-sm', children: index + 1 }),
                    }),
                    _jsx('span', {
                      className: cn(
      ...
      _jsx(Card, {
        className: 'overflow-hidden rounded-xl border-none bg-background py-0 shadow-xl dark:bg-black',
        children: _jsx(CardContent, {
          className: 'p-8',
          children: _jsx('div', { className: 'relative', children: currentStep.component }),
        }),
      }),
      _jsxs('div', {
        ...
        children: [
          _jsxs(Button, {
            ...
            children: [_jsx(ChevronLeft, { className: 'h-4 w-4' }), ' Previous'],
          }),
          _jsxs(Button, {
            ...
            children: [
              ...
              !isLastStep && _jsx(ChevronRight, { className: 'ml-2 h-4 w-4' }),
            ],
          }),
        ],
      }),
